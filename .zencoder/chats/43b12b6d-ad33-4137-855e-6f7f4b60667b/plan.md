# Course Creation Plan - Level B2

## Phase 1: Structure & Pedagogical Design
- [x] Analyze B1 course structure and exercise types
- [x] Define thematic structure for 30 B2 units (50 exercises each)
- [x] Obtain user confirmation for the 30-unit structure (Real B2 Level)

## Phase 2: Unit Implementation (One by One)
- [x] Unit 1: Relationships and Social Life
- [x] Unit 2: Technology and Innovation
- [/] Unit 3: Environmental Issues (In Progress)
...
- [ ] Unit 29: Mind and Memory
- [ ] Unit 30: Final Review

## Workflow for each unit:
1. Generate 50 exercises (25 sentence-building, 25 multiple-choice).
2. Ensure B2 level complexity and neutral tone.
3. Use the `[[English|Spanish]]` format for all strings.
4. Add audio paths following the pattern `audio/b2/unit-X/eY.mp3`.
5. Present the unit to the user for review.
6. Once confirmed, move to the next unit.
