                ...
                <div key={question.id} className="bg-white rounded-lg p-5 border-2 border-slate-200">
                  ...
                  {question.hint && !showFeedback && (
                    <div className="mb-3 p-3 bg-blue-50 border-2 border-blue-200 rounded-lg">
                      <p className="text-sm text-blue-900">
                        <span className="font-semibold">💡 Pista:</span> {question.hint}
                      </p>
                    </div>
                  )}
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border-2 rounded-lg transition-all ${
                        showFeedback
                          ...
                          : 'border-slate-300'
                      } disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-amber-400`}
                    />
                  </div>
                    ...
                    <div className={`mt-4 p-3 rounded-lg ${
                      ...
                      {answers[question.id] !== question.correctAnswer && (
                        <p className="text-sm mb-2">
                          ...
                          <span className="text-red-700">{answers[question.id] || '(vacío)'}</span>
                        </p>
                      )}
                      <p className="text-sm mb-2">
                        <span className="font-semibold">Respuesta correcta:</span>{' '}
