...
✅ Lee el primer párrafo completo
✅ Luego lee la primera frase de cada párrafo
✅ Responde las preguntas fáciles primero
✅ Deja las de resumen para el final
...
**Toma de Notas**:
```
Main Topic: _________________

Key Point 1: ________________
  - Example: ________________

Key Point 2: ________________
  - Example: ________________
...
**Estrategias**:
✅ Toma notas con abreviaciones
✅ Anota ejemplos específicos (dates, names)
✅ Atiende a transiciones ("however", "for example")
✅ No te obsesiones con una palabra perdida

---

### 💬 Speaking (17min)
**4 tareas: 1 independiente + 3 integradas**

**Task 1 (Independent)**: Opinión personal (45 seg)
- "Do you prefer to study alone or with friends?"

**Task 2 (Integrated)**: Leer + Escuchar + Hablar
- Leer anuncio de universidad
- Escuchar opinión de estudiantes
- Resumir (60 seg)

**Task 3-4**: Escuchar + Hablar
- Lecture académica
- Resumir puntos principales (60 seg)

**Estructura de Respuesta**:
```
Introduction (5 seg): State your position
Reason 1 (20 seg): First point + example
Reason 2 (15 seg): Second point + example
Conclusion (5 seg): Restate position
```
...
**Task 1 - Integrated (20min)**:
- Leer pasaje académico (3 min)
- Escuchar lecture que contradice el texto
- Escribir comparación (150-225 palabras)

**Estructura**:
```
Intro: "The reading and the lecture are about..."

Body 1: First point of reading vs lecture

Body 2: Second point of reading vs lecture

Body 3: Third point of reading vs lecture
```

**Task 2 - Independent (30min)**:
- Essay de opinión (300+ palabras)
- "Do you agree or disagree: Technology makes life easier?"

**Estructura**:
```
Intro (50 palabras): Hook + Thesis
Body 1 (100 palabras): First reason + 2 examples
Body 2 (100 palabras): Second reason + 2 examples
Conclusion (50 palabras): Restate + final thought
```
...
**Task 1 (20min, 150 palabras)**:

**Academic**: Describir gráfico/tabla/diagrama
```
Introduction: Paraphrase the question
Overview: General trend (don't include numbers)
Body 1: Specific details group 1
Body 2: Specific details group 2
```

**General Training**: Escribir carta
- Formal / Semi-formal / Informal

**Task 2 (40min, 250 palabras)**: Essay argumentativo

**Estructura de 4 Párrafos**:
```
Para 1: Introduction + Thesis
Para 2: Main point 1 + explanation + example
Para 3: Main point 2 + explanation + example
Para 4: Conclusion + recommendation
```
...
**Part 1 (4-5min)**: Introduction & Interview
- Preguntas sobre ti, familia, trabajo, estudios, hobbies

**Part 2 (3-4min)**: Long Turn
- Tarjeta con tema
- 1 minuto preparación
- 2 minutos hablando
...
**Part 3 (4-5min)**: Discussion
- Preguntas abstractas relacionadas con Part 2
- Más profundas y filosóficas
...
### Apps y Plataformas
- **Magoosh**: TOEFL e IELTS prep
- **British Council IELTS Prep**: App oficial
- **Cambridge English**: Practice tests online
- **Quizlet**: Flashcards de vocabulario

### YouTube Channels
- **IELTS Liz**: Estrategias y ejemplos
- **E2 IELTS**: Tips y mock tests
- **NoteFull TOEFL Mastery**: TOEFL strategies
- **Cambridge English**: Official videos

---

## 💡 Consejos Universales para Cualquier Examen

### 1. Gestión del Tiempo
⏰ **Practica con cronómetro** desde el inicio
⏰ **Deja tiempo para revisar** (5 minutos al final)
⏰ **No te quedes atascado** en una pregunta difícil

### 2. Vocabulario
📖 **Aprende raíces, prefijos y sufijos**
📖 **Crea listas temáticas** (educación, tecnología, medio ambiente)
📖 **Usa el vocabulario** en speaking y writing

### 3. Estrategias de Respuesta
✅ **Lee las instrucciones cuidadosamente**
✅ **Elimina opciones incorrectas** primero
...
**Por qué es malo**: Formato puede ser diferente
**Solución**: Usa siempre materiales oficiales para practice tests

### Error 2: No Practicar Con Cronómetro
**Por qué es malo**: No aprenderás gestión del tiempo
**Solución**: TODOS los practice deben ser con tiempo real

### Error 3: Memorizar Plantillas Rígidas
**Por qué es malo**: Los examinadores lo detectan
**Solución**: Aprende estructuras flexibles, no textos memorizados

### Error 4: Descuidar una Sección
