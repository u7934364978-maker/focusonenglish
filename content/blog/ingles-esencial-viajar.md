...
description: "Las frases y expresiones más importantes que necesitas dominar para viajar con confianza. Guía práctica con ejemplos reales para aeropuertos, hoteles, restaurantes y emergencias."
date: "2026-01-12"
category: "viajes"
...
Viajar al extranjero puede ser intimidante si no dominas el idioma, pero con las **frases correctas y preparación básica**, puedes desenvolverte con confianza en cualquier destino de habla inglesa.

Esta guía te proporciona el **inglés práctico y real** que necesitarás en tus viajes, organizado por situaciones específicas.
...
```
✈️ Check-in counter (Mostrador de facturación)

✅ "I'd like to check in for flight BA205 to London"
   (Me gustaría hacer el check-in para el vuelo BA205 a Londres)

✅ "How many bags can I check in?"
   (¿Cuántas maletas puedo facturar?)

✅ "Is this bag within the weight limit?"
   (¿Esta maleta está dentro del límite de peso?)

✅ "Can I have a window/aisle seat, please?"
   (¿Puedo tener un asiento de ventana/pasillo, por favor?)
```
...
### Control de Seguridad y Migración
...
You: "Two weeks" / "One month"

Officer: "Where will you be staying?"
You: "At the Hilton Hotel downtown" / "With friends"
```
...
```
🏨 Hotel Reception (Recepción del hotel)

You: "Good evening, I have a reservation under [Your Name]"

Receptionist: "Let me check... Yes, I have a double room for three nights. Can I see your passport and credit card, please?"

You: "Here you are. What time is breakfast?"

Receptionist: "Breakfast is served from 7 to 10 AM on the second floor. Here's your key card. Your room is 305 on the third floor."

You: "Thank you. Is there Wi-Fi in the room?"

Receptionist: "Yes, the password is written on the welcome card in your room."
```
...
```
⚠️ Room Issues (Problemas en la habitación)
...
✅ "The TV remote doesn't work"
   (El control remoto de la TV no funciona)

✅ "Could I get some extra towels/pillows?"
   (¿Podría conseguir toallas/almohadas extras?)

✅ "I'd like to change rooms, please"
   (Me gustaría cambiar de habitación, por favor)
```
...
✅ "I'd like to check out, please. Room 305"

✅ "Can I leave my luggage here until this evening?"
   (¿Puedo dejar mi equipaje aquí hasta esta noche?)

✅ "Could you call a taxi for me?"
   (¿Podría llamarme un taxi?)

✅ "Is there a charge for late checkout?"
   (¿Hay cargo por salida tardía?)
```

---

## 🍽️ En Restaurantes y Cafés
...
```
📞 Making a Reservation (Haciendo una reserva)

✅ "I'd like to make a reservation for two people at 8 PM tonight"

✅ "Do you have any tables available for dinner?"
...
```
🍴 Ordering Food (Ordenando comida)
...
Waiter: "Any sides with that?"
You: "The vegetables and mashed potatoes, please"
...
✅ "I'm vegetarian/vegan. What would you recommend?"

✅ "I'm allergic to peanuts/shellfish"
   (Soy alérgico a los cacahuetes/mariscos)

✅ "Does this dish contain dairy/gluten?"
   (¿Este plato contiene lácteos/gluten?)

✅ "Could I have the dressing on the side?"
   (¿Podría traer el aderezo aparte?)

✅ "Can you make this dish spicy/mild?"
   (¿Pueden hacer este plato picante/suave?)
```
...
✅ "Could you use the meter, please?"
   (¿Podría usar el taxímetro, por favor?)
...
✅ "Which line goes to Central Station?"

✅ "Where do I need to change trains?"

✅ "Is this the right platform for...?"

✅ "How many stops until [station]?"
...
✅ "Can I get a VAT refund?" (Devolución de IVA para turistas)
```
...
```
🆘 Lost Documents (Documentos perdidos)
