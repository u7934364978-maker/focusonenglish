...
test.describe('Unit 10 Expansion', () => {
  test('should have 60 exercises in Unit 10', async ({ page }) => {
    await page.goto('http://127.0.0.1:5436/debug/a1-preview/unit-10');
    
    // Wait for exercises to load
    await expect(page.locator('h1')).toContainText('Review: Unidad 10', { timeout: 15000 });
