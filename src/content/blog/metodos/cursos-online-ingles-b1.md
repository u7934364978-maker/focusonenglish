...
faqs:
  - question: "¿Qué nivel de inglés es el B1?"
    answer: "El nivel B1 corresponde al nivel intermedio según el Marco Común Europeo de Referencia para las lenguas (MCER). Significa que puedes comunicarte en situaciones cotidianas y laborales de forma independiente."
  - question: "¿Cuánto tiempo se tarda en sacar el B1 de inglés?"
    answer: "Dependiendo de tu base actual, con nuestro método intensivo puedes alcanzar el nivel B1 en un periodo de 3 a 6 meses dedicando unas horas semanales."
  - question: "¿Es válido este curso para exámenes oficiales?"
    answer: "Sí, nuestro temario está diseñado para cubrir los requisitos de exámenes como Cambridge (PET), Aptis, Oxford Test of English y los exámenes de la Escuela Oficial de Idiomas."
---

# Cursos Online de Inglés B1: Domina el Nivel Intermedio

¿Necesitas el **B1 de inglés** para tu carrera universitaria, un ascenso en el trabajo o simplemente para viajar con confianza? El nivel B1 (Umbral) es el punto de inflexión donde dejas de ser un principiante para convertirte en un usuario independiente del idioma. En **Focus English**, hemos diseñado una estrategia de aprendizaje optimizada para que consigas tu certificado oficial de la manera más rápida y eficiente.
