...
Si ya conoces los saludos básicos y puedes decir tu nombre y profesión, el **Nivel A2** (Plataforma) es donde ocurre la verdadera transformación. Es el momento en el que dejas de "sobrevivir" con el idioma y empiezas a **comunicar tus experiencias**. En el **[nivel elemental de inglés](/blog/metodos/ingles-a2)**, el objetivo es ganar la confianza suficiente para moverte por el mundo con independencia.
