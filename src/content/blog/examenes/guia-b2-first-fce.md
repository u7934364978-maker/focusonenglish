...
El **B2 First**, comúnmente conocido como **First Certificate in English (FCE)**, es uno de los exámenes de inglés más populares del mundo. Certifica que posees las habilidades lingüísticas necesarias para vivir y trabajar de forma independiente en un país de habla inglesa o para estudiar cursos impartidos en inglés.

Aprobar el **examen Cambridge First** demuestra que puedes:
*   Comunicarte eficazmente cara a cara, expresando opiniones y presentando argumentos.
*   Escribir un inglés claro y detallado, expresando opiniones y explicando las ventajas y desventajas de diferentes puntos de vista.
*   Seguir las noticias.
