...
canonical: "https://focusonenglish.ai/curso-ingles-gramatica-ingles-b1-guia"
...
- **Present Perfect Simple vs Past Simple**: ¿Cuándo usamos uno u otro? La clave está en si la acción ha terminado o sigue vinculada al presente.
- **Past Continuous**: Fundamental para narrar historias y dar contexto.

## 2. Los Condicionales (0, 1 y 2)
El B1 exige el uso del **Second Conditional** para situaciones hipotéticas:
- *If I won the lottery, I would travel around the world.*

## 3. Voz Pasiva
Aprende a poner el foco en la acción y no en el sujeto. Muy útil para redacciones formales y noticias.
- *The bridge was built in 1920.*

## 4. Oraciones de Relativo
Une frases para que tu inglés suene más natural utilizando *who, which, that* y *where*.

---

### ¿Quieres practicar estos temas con ejercicios interactivos?
