...
export const C2_U36_BLOCK1: Exercise = {
  "id": "c2-u36-b1",
  "type": "grammar",
  "title": "Block 1: Grammar Input & Presentation",
  "explanation": "Grammar Input & Presentation practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b1-q1",
...
export const C2_U36_BLOCK2: Exercise = {
  "id": "c2-u36-b2",
  "type": "grammar-context",
  "title": "Block 2: Grammar in Context / Collocations",
  "explanation": "Grammar in Context / Collocations practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b2-q1",
      "type": "open-cloze",
...
export const C2_U36_BLOCK3: Exercise = {
  "id": "c2-u36-b3",
  "type": "reading",
  "title": "Block 3: Reading Comprehension (C2 Text)",
  "explanation": "Reading Comprehension (C2 Text) practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b3-q1",
...
export const C2_U36_BLOCK4: Exercise = {
  "id": "c2-u36-b4",
  "type": "listening",
  "title": "Block 4: Listening / Discourse Management",
  "explanation": "Listening / Discourse Management practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b4-q1",
      "type": "multiple-choice",
...
export const C2_U36_BLOCK5: Exercise = {
  "id": "c2-u36-b5",
  "type": "writing",
  "title": "Block 5: Writing Practice (Genre-specific)",
  "explanation": "Writing Practice (Genre-specific) practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b5-q1",
      "type": "multiple-choice",
...
export const C2_U36_BLOCK6: Exercise = {
  "id": "c2-u36-b6",
  "type": "speaking",
  "title": "Block 6: Speaking / Review / Integration",
  "explanation": "Speaking / Review / Integration practice for \"Module 6 Review: Philosophy\" — mixed-review-m6",
  "questions": [
    {
      "id": "c2-u36-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_36 = createC2Unit(
  'c2-u36',
  'Module 6 Review: Philosophy',
