...
const PLACEHOLDER_BLOCK = (blockNum: number): Exercise => ({
  ...
  questions: Array.from({ length: 10 }, (_, q) => ({
    id: 'c2-u58-b' + blockNum + '-q' + (q + 1),
    type: 'fill-blank',
    question: 'Placeholder question for Unit 58, Block ' + blockNum + ', Question ' + (q + 1),
...
export const unit58 = createC2Unit(
  'c2-u58',
  'Unit 58: Advanced Proficiency',
