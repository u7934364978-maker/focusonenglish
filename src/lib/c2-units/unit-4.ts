...
export const C2_U4_BLOCK1: Exercise = {
  ...
  "explanation": "Grammar Input & Presentation practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b1-q1",
...
export const C2_U4_BLOCK2: Exercise = {
  ...
  "explanation": "Grammar in Context / Collocations practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b2-q1",
      "type": "open-cloze",
...
export const C2_U4_BLOCK3: Exercise = {
  ...
  "explanation": "Reading Comprehension (C2 Text) practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b3-q1",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"It remains to be seen whether the proposed reforms will have the desired effect...\"",
      "options": [
        "mitigate",
        "alleviate",
        "diminish",
    ...
    },
    {
      "id": "c2-u4-b3-q2",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"So complex is the relationship between language and thought that researchers continue to debate its nature...\"",
      "options": [
        "pervasive",
        "widespread",
        "rampant",
    ...
    },
    {
      "id": "c2-u4-b3-q3",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"The committee decided to postpone the meeting until further notice...\"",
      "options": [
        "ambiguous",
        "equivocal",
        "vague",
    ...
    },
    {
      "id": "c2-u4-b3-q4",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"It is widely believed that language shapes our perception of reality...\"",
      "options": [
        "undermine",
        "erode",
        "diminish",
    ...
    },
    {
      "id": "c2-u4-b3-q5",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"Not only did the author challenge conventional views, but she also proposed radical alternatives...\"",
      "options": [
        "contentious",
        "controversial",
        "debatable",
    ...
    },
    {
      "id": "c2-u4-b3-q6",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"The government has been accused of failing to address the underlying causes of the crisis...\"",
      "options": [
        "ostensibly",
        "apparently",
        "seemingly",
    ...
    },
    {
      "id": "c2-u4-b3-q7",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"Had the delegates arrived on time, the negotiations would have proceeded smoothly...\"",
      "options": [
        "profoundly",
        "utterly",
        "considerably",
    ...
    },
    {
      "id": "c2-u4-b3-q8",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"There is a growing body of evidence suggesting that bilingualism enhances cognitive flexibility...\"",
      "options": [
        "however",
        "nevertheless",
        "despite",
    ...
    },
    {
      "id": "c2-u4-b3-q9",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"The report highlights the extent to which economic inequality perpetuates social immobility...\"",
      "options": [
        "scrutinise",
        "examine",
        "verify",
    ...
    },
    {
      "id": "c2-u4-b3-q10",
      "type": "multiple-choice",
      "question": "In the context of language-identity, choose the most appropriate word: \"Rarely has such a comprehensive analysis been published in a single volume...\"",
      "options": [
        "endorsed",
        "advocated",
        "upheld",
...
export const C2_U4_BLOCK4: Exercise = {
  ...
  "explanation": "Listening / Discourse Management practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b4-q1",
      "type": "multiple-choice",
...
export const C2_U4_BLOCK5: Exercise = {
  ...
  "explanation": "Writing Practice (Genre-specific) practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b5-q1",
      "type": "multiple-choice",
...
export const C2_U4_BLOCK6: Exercise = {
  ...
  "explanation": "Speaking / Review / Integration practice for \"Language and Identity\" — register-control",
  "questions": [
    {
      "id": "c2-u4-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_4 = createC2Unit(
  ...
  'Advanced C2 level practice on language-identity.',
