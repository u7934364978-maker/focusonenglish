...
export const C2_U15_BLOCK1: Exercise = {
  ...
  "explanation": "Grammar Input & Presentation practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b1-q1",
...
export const C2_U15_BLOCK2: Exercise = {
  ...
  "explanation": "Grammar in Context / Collocations practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b2-q1",
      "type": "open-cloze",
...
export const C2_U15_BLOCK3: Exercise = {
  ...
  "explanation": "Reading Comprehension (C2 Text) practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b3-q1",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"There is a growing body of evidence suggesting that bilingualism enhances cognitive flexibility...\"",
      "options": [
        "ostensibly",
        "apparently",
        "seemingly",
    ...
    },
    {
      "id": "c2-u15-b3-q2",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"The report highlights the extent to which economic inequality perpetuates social immobility...\"",
      "options": [
        "profoundly",
        "utterly",
        "considerably",
    ...
    },
    {
      "id": "c2-u15-b3-q3",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"Rarely has such a comprehensive analysis been published in a single volume...\"",
      "options": [
        "however",
        "nevertheless",
        "despite",
    ...
    },
    {
      "id": "c2-u15-b3-q4",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"It remains to be seen whether the proposed reforms will have the desired effect...\"",
      "options": [
        "scrutinise",
        "examine",
        "verify",
    ...
    },
    {
      "id": "c2-u15-b3-q5",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"So complex is the relationship between language and thought that researchers continue to debate its nature...\"",
      "options": [
        "endorsed",
        "advocated",
        "upheld",
    ...
    },
    {
      "id": "c2-u15-b3-q6",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"The committee decided to postpone the meeting until further notice...\"",
      "options": [
        "mitigate",
        "alleviate",
        "diminish",
    ...
    },
    {
      "id": "c2-u15-b3-q7",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"It is widely believed that language shapes our perception of reality...\"",
      "options": [
        "pervasive",
        "widespread",
        "rampant",
    ...
    },
    {
      "id": "c2-u15-b3-q8",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"Not only did the author challenge conventional views, but she also proposed radical alternatives...\"",
      "options": [
        "ambiguous",
        "equivocal",
        "vague",
    ...
    },
    {
      "id": "c2-u15-b3-q9",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"The government has been accused of failing to address the underlying causes of the crisis...\"",
      "options": [
        "undermine",
        "erode",
        "diminish",
    ...
    },
    {
      "id": "c2-u15-b3-q10",
      "type": "multiple-choice",
      "question": "In the context of media-information, choose the most appropriate word: \"Had the delegates arrived on time, the negotiations would have proceeded smoothly...\"",
      "options": [
        "contentious",
        "controversial",
        "debatable",
...
export const C2_U15_BLOCK4: Exercise = {
  ...
  "explanation": "Listening / Discourse Management practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b4-q1",
      "type": "multiple-choice",
...
export const C2_U15_BLOCK5: Exercise = {
  ...
  "explanation": "Writing Practice (Genre-specific) practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b5-q1",
      "type": "multiple-choice",
...
export const C2_U15_BLOCK6: Exercise = {
  ...
  "explanation": "Speaking / Review / Integration practice for \"Fake News and Information Wars\" — hedging-c2",
  "questions": [
    {
      "id": "c2-u15-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_15 = createC2Unit(
  'c2-u15',
  'Fake News and Information Wars',
  'Advanced C2 level practice on media-information.',
