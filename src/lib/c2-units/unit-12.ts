...
export const C2_U12_BLOCK1: Exercise = {
  ...
  "explanation": "Grammar Input & Presentation practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b1-q1",
...
export const C2_U12_BLOCK2: Exercise = {
  ...
  "explanation": "Grammar in Context / Collocations practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b2-q1",
      "type": "open-cloze",
...
export const C2_U12_BLOCK3: Exercise = {
  ...
  "explanation": "Reading Comprehension (C2 Text) practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b3-q1",
...
export const C2_U12_BLOCK4: Exercise = {
  ...
  "explanation": "Listening / Discourse Management practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b4-q1",
      "type": "multiple-choice",
...
export const C2_U12_BLOCK5: Exercise = {
  ...
  "explanation": "Writing Practice (Genre-specific) practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b5-q1",
      "type": "multiple-choice",
...
export const C2_U12_BLOCK6: Exercise = {
  ...
  "explanation": "Speaking / Review / Integration practice for \"Module 2 Review: Literature\" — mixed-review-m2",
  "questions": [
    {
      "id": "c2-u12-b6-q1",
      "type": "multiple-choice",
