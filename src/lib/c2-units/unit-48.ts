...
export const C2_U48_BLOCK1: Exercise = {
  ...
  "explanation": "Grammar Input & Presentation practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b1-q1",
...
export const C2_U48_BLOCK2: Exercise = {
  ...
  "explanation": "Grammar in Context / Collocations practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b2-q1",
      "type": "open-cloze",
...
export const C2_U48_BLOCK3: Exercise = {
  ...
  "explanation": "Reading Comprehension (C2 Text) practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b3-q1",
...
export const C2_U48_BLOCK4: Exercise = {
  ...
  "explanation": "Listening / Discourse Management practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b4-q1",
      "type": "multiple-choice",
...
export const C2_U48_BLOCK5: Exercise = {
  ...
  "explanation": "Writing Practice (Genre-specific) practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b5-q1",
      "type": "multiple-choice",
...
export const C2_U48_BLOCK6: Exercise = {
  ...
  "explanation": "Speaking / Review / Integration practice for \"Module 8 Review: Global Challenges\" — mixed-review-m8",
  "questions": [
    {
      "id": "c2-u48-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_48 = createC2Unit(
  'c2-u48',
  'Module 8 Review: Global Challenges',
