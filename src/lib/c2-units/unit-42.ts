...
export const C2_U42_BLOCK1: Exercise = {
  ...
  "explanation": "Grammar Input & Presentation practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b1-q1",
...
export const C2_U42_BLOCK2: Exercise = {
  ...
  "explanation": "Grammar in Context / Collocations practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b2-q1",
      "type": "open-cloze",
...
export const C2_U42_BLOCK3: Exercise = {
  ...
  "explanation": "Reading Comprehension (C2 Text) practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b3-q1",
...
export const C2_U42_BLOCK4: Exercise = {
  ...
  "explanation": "Listening / Discourse Management practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b4-q1",
      "type": "multiple-choice",
...
export const C2_U42_BLOCK5: Exercise = {
  ...
  "explanation": "Writing Practice (Genre-specific) practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b5-q1",
      "type": "multiple-choice",
...
export const C2_U42_BLOCK6: Exercise = {
  ...
  "explanation": "Speaking / Review / Integration practice for \"Module 7 Review: Economics and Law\" — mixed-review-m7",
  "questions": [
    {
      "id": "c2-u42-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_42 = createC2Unit(
  'c2-u42',
  'Module 7 Review: Economics and Law',
