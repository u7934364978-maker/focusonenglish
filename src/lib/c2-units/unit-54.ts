...
export const C2_U54_BLOCK1: Exercise = {
  "id": "c2-u54-b1",
  "type": "grammar",
  "title": "Block 1: Grammar Input & Presentation",
  "explanation": "Grammar Input & Presentation practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b1-q1",
...
export const C2_U54_BLOCK2: Exercise = {
  "id": "c2-u54-b2",
  "type": "grammar-context",
  "title": "Block 2: Grammar in Context / Collocations",
  "explanation": "Grammar in Context / Collocations practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b2-q1",
      "type": "open-cloze",
...
export const C2_U54_BLOCK3: Exercise = {
  "id": "c2-u54-b3",
  "type": "reading",
  "title": "Block 3: Reading Comprehension (C2 Text)",
  "explanation": "Reading Comprehension (C2 Text) practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b3-q1",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"It remains to be seen whether the proposed reforms will have the desired effect...\"",
      "options": [
        "mitigate",
        "alleviate",
        "diminish",
    ...
    },
    {
      "id": "c2-u54-b3-q2",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"So complex is the relationship between language and thought that researchers continue to debate its nature...\"",
      "options": [
        "pervasive",
        "widespread",
        "rampant",
    ...
    },
    {
      "id": "c2-u54-b3-q3",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"The committee decided to postpone the meeting until further notice...\"",
      "options": [
        "ambiguous",
        "equivocal",
        "vague",
    ...
    },
    {
      "id": "c2-u54-b3-q4",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"It is widely believed that language shapes our perception of reality...\"",
      "options": [
        "undermine",
        "erode",
        "diminish",
    ...
    },
    {
      "id": "c2-u54-b3-q5",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"Not only did the author challenge conventional views, but she also proposed radical alternatives...\"",
      "options": [
        "contentious",
        "controversial",
        "debatable",
    ...
    },
    {
      "id": "c2-u54-b3-q6",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"The government has been accused of failing to address the underlying causes of the crisis...\"",
      "options": [
        "ostensibly",
        "apparently",
        "seemingly",
    ...
    },
    {
      "id": "c2-u54-b3-q7",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"Had the delegates arrived on time, the negotiations would have proceeded smoothly...\"",
      "options": [
        "profoundly",
        "utterly",
        "considerably",
    ...
    },
    {
      "id": "c2-u54-b3-q8",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"There is a growing body of evidence suggesting that bilingualism enhances cognitive flexibility...\"",
      "options": [
        "however",
        "nevertheless",
        "despite",
    ...
    },
    {
      "id": "c2-u54-b3-q9",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"The report highlights the extent to which economic inequality perpetuates social immobility...\"",
      "options": [
        "scrutinise",
        "examine",
        "verify",
    ...
    },
    {
      "id": "c2-u54-b3-q10",
      "type": "multiple-choice",
      "question": "In the context of review, choose the most appropriate word: \"Rarely has such a comprehensive analysis been published in a single volume...\"",
      "options": [
        "endorsed",
        "advocated",
        "upheld",
...
export const C2_U54_BLOCK4: Exercise = {
  "id": "c2-u54-b4",
  "type": "listening",
  "title": "Block 4: Listening / Discourse Management",
  "explanation": "Listening / Discourse Management practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b4-q1",
      "type": "multiple-choice",
...
export const C2_U54_BLOCK5: Exercise = {
  "id": "c2-u54-b5",
  "type": "writing",
  "title": "Block 5: Writing Practice (Genre-specific)",
  "explanation": "Writing Practice (Genre-specific) practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b5-q1",
      "type": "multiple-choice",
...
export const C2_U54_BLOCK6: Exercise = {
  "id": "c2-u54-b6",
  "type": "speaking",
  "title": "Block 6: Speaking / Review / Integration",
  "explanation": "Speaking / Review / Integration practice for \"Module 9 Review: Culture and Language\" — mixed-review-m9",
  "questions": [
    {
      "id": "c2-u54-b6-q1",
      "type": "multiple-choice",
...
export const C2_UNIT_54 = createC2Unit(
  'c2-u54',
  'Module 9 Review: Culture and Language',
  'Advanced C2 level practice on review.',
