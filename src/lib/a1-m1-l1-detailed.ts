...
const GRAMMAR_QUESTIONS = [
  // Recognition (1-15)
  { id: 'q1', type: 'multiple-choice', question: 'It is 8:00 [[AM|de la mañana]]. You say: "Good ___!"', options: ['morning', 'afternoon', 'evening'], correctAnswer: 'morning', explanation: 'Usamos "Good morning" para saludar desde que amanece hasta el mediodía (12:00 PM).', imageUrl: 'https://images.unsplash.com/photo-1470252649358-96947c029b98?w=800&auto=format&fit=crop', audioUrl: '/audio/a1/unit-1/q1.mp3' },
  { id: 'q2', type: 'multiple-choice', question: 'It is 3:00 [[PM|de la tarde]]. You say: "Good ___!"', options: ['morning', 'afternoon', 'evening'], correctAnswer: 'afternoon', explanation: 'Usamos "Good afternoon" desde el mediodía hasta aproximadamente las 6:00 PM.', imageUrl: 'https://images.unsplash.com/photo-1510443048590-06900f606775?w=800&auto=format&fit=crop' },
  { id: 'q3', type: 'multiple-choice', question: 'When you go to sleep, you say: "Good ___!"', options: ['morning', 'afternoon', 'night'], correctAnswer: 'night', explanation: '"Good night" no es un saludo de llegada, sino una despedida que se usa antes de ir a dormir o al final de la noche.', imageUrl: 'https://images.unsplash.com/photo-1505322022379-7c3353ee615c?w=800&auto=format&fit=crop' },
