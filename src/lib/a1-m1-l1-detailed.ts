...
const GRAMMAR_QUESTIONS = [
  // Recognition (1-15)
  { id: 'q1', type: 'multiple-choice', question: 'It is 8:00 [[AM|de la mañana]]. You say: "Good ___!"', options: ['morning', 'afternoon', 'evening'], correctAnswer: 'morning' },
  { id: 'q2', type: 'multiple-choice', question: 'It is 3:00 [[PM|de la tarde]]. You say: "Good ___!"', options: ['morning', 'afternoon', 'evening'], correctAnswer: 'afternoon' },
  ...
  { id: 'q12', type: 'true-false', question: 'We can use "Good morning" at 11:00 [[PM|de la noche]].', correctAnswer: 'False' },
  ...
  { id: 'q16', type: 'multiple-choice', question: 'Select the [[contraction|contracción]] for "I am":', options: ["I'm", "I's", "I're"], correctAnswer: "I'm" },
  { id: 'q17', type: 'true-false', question: 'The [[contraction|contracción]] for "You are" is "You\'is".', correctAnswer: 'False' },
  { id: 'q18', type: 'multiple-choice', question: 'Select the [[contraction|contracción]] for "He is":', options: ["He's", "He're", "He'm"], correctAnswer: "He's" },
  { id: 'q19', type: 'true-false', question: 'We [[use|utilizamos]] "She" [[for|para]] a [[man|hombre]].', correctAnswer: 'False' },
  { id: 'q20', type: 'multiple-choice', question: 'Identify the [[pronoun|pronombre]] for a [[boy|niño]]:', options: ['He', 'She', 'It'], correctAnswer: 'He' },
  { id: 'q21', type: 'true-false', question: 'We [[use|utilizamos]] "It" [[for|para]] a [[person|persona]].', correctAnswer: 'False' },
  { id: 'q22', type: 'fill-blank', question: "I ___ [[fine|bien]], [[thanks|gracias]].", correctAnswer: "am" },
  { id: 'q23', type: 'multiple-choice', question: 'Nice to ___ you.', options: ['see', 'meet', 'look'], correctAnswer: 'meet' },
  { id: 'q24', type: 'true-false', question: 'We [[use|utilizamos]] "It is" [[for|para]] [[animals|animales]] [[and|y]] [[objects|objetos]].', correctAnswer: 'True' },
  { id: 'q25', type: 'multiple-choice', question: 'Choose the [[correct|correcta]] [[formal|formal]] [[greeting|saludo]]:', options: ['Hi!', 'Hey!', 'Good afternoon.'], correctAnswer: 'Good afternoon.' },
  { id: 'q26', type: 'true-false', question: 'The [[verb|verbo]] "to be" [[has|tiene]] 5 [[forms|formas]] [[for|para]] "I".', correctAnswer: 'False' },
  { id: 'q27', type: 'multiple-choice', question: 'What is the [[subject|sujeto]] [[pronoun|pronombre]] [[for|para]] "Yo"?', options: ['You', 'I', 'Me'], correctAnswer: 'I' },
  { id: 'q28', type: 'multiple-choice', question: 'Complete: ___ is my [[teacher|profesor/a]].', options: ['I', 'He', 'You'], correctAnswer: 'He' },
  { id: 'q29', type: 'true-false', question: 'The [[contraction|contracción]] [[for|para]] "She is" is "She\'s".', correctAnswer: 'True' },
  { id: 'q30', type: 'true-false', question: 'The [[plural|plural]] [[of|de]] "He" is "I".', correctAnswer: 'False' },
  // Practice (31-50)
  { id: 'q31', type: 'multiple-choice', question: 'Select the [[correct|correcta]] [[sentence|oración]]:', options: ['I am happy.', 'Am I happy.', 'I happy am.'], correctAnswer: 'I am happy.' },
  { id: 'q32', type: 'multiple-choice', question: 'Select the [[correct|correcta]] [[sentence|oración]]:', options: ['You are tall.', 'Are you tall.', 'You tall are.'], correctAnswer: 'You are tall.' },
  { id: 'q33', type: 'fill-blank', question: "___ is a [[cat|gato]].", correctAnswer: "It" },
  { id: 'q34', type: 'multiple-choice', question: 'Goodbye, [[see|nos vemos]] you [[later|luego]]!', options: ['me', 'you', 'it'], correctAnswer: 'you' },
  { id: 'q35', type: 'fill-blank', question: "He ___ [[from|de]] Mexico.", correctAnswer: "is" },
  { id: 'q36', type: 'multiple-choice', question: 'Which [[is|es]] [[correct|correcto]]?', options: ["I'm fine.", "I is fine.", "I are fine."], correctAnswer: "I'm fine." },
  { id: 'q37', type: 'fill-blank', question: "___ are welcome.", correctAnswer: "You" },
  { id: 'q38', type: 'multiple-choice', question: 'It is 7:00 [[PM|de la noche]]. You arrive. You say:', options: ['Good morning.', 'Good afternoon.', 'Good evening.'], correctAnswer: 'Good evening.' },
  { id: 'q39', type: 'multiple-choice', question: 'It is 11:00 [[PM|de la noche]]. You leave. You say:', options: ['Good night.', 'Good evening.', 'Good afternoon.'], correctAnswer: 'Good night.' },
  { id: 'q40', type: 'fill-blank', question: "She ___ a [[student|estudiante]].", correctAnswer: "is" },
  ...
  { id: 'q43', type: 'fill-blank', question: "___ [[name|nombre]] is John.", correctAnswer: "My" },
  { id: 'q44', type: 'multiple-choice', question: 'What is the [[opposite|opuesto]] [[of|de]] "Hello"?', options: ['Hi', 'Goodbye', 'Good morning'], correctAnswer: 'Goodbye' },
  { id: 'q45', type: 'true-false', question: '"I" is [[always|siempre]] [[capitalized|en mayúsculas]] [[in|en]] English.', correctAnswer: 'True' },
  ...
  { id: 'q49', type: 'fill-blank', question: "See you [[later|luego]].", correctAnswer: "later" },
  { id: 'q50', type: 'multiple-choice', question: 'Choose the [[best|mejor]] [[greeting|saludo]] [[for|para]] a [[job|trabajo]] [[interview|entrevista]]:', options: ['Hey!', 'Hello, good morning.', 'Sup?'], correctAnswer: 'Hello, good morning.' },
  // More practice to reach 55
  { id: 'q51', type: 'fill-blank', question: "I ___ a [[student|estudiante]] at Focus English.", correctAnswer: "am" },
  ...
  { id: 'q54', type: 'fill-blank', question: "___ are my [[friend|amigo]].", correctAnswer: "You" },
