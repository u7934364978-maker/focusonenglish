...
export const A1_M1_L3_LISTENING = {
  ...
  structuredTranscript: [
    { start: 0, end: 5, speaker: 'Interviewer', text: 'Hello! Welcome to our international student meeting. Can you introduce yourself?' },
    { start: 5, end: 10, speaker: 'Anna', text: "Hi! My name is Anna. I'm from Germany. I'm German." },
    { start: 10, end: 15, speaker: 'Interviewer', text: 'Nice to meet you, Anna! And you?' },
    { start: 15, end: 20, speaker: 'Chen', text: "Hello, I'm Chen. I'm from China. I'm Chinese." },
    { start: 20, end: 25, speaker: 'Interviewer', text: 'Great! Are you both students here?' },
    { start: 25, end: 30, speaker: 'Anna', text: 'Yes, I am. I study computer science.' },
    { start: 30, end: 35, speaker: 'Chen', text: "I'm a student too. I study business." },
    { start: 35, end: 40, speaker: 'Interviewer', text: 'Wonderful! Do you speak English well?' },
    { start: 40, end: 45, speaker: 'Anna', text: 'I speak English, but I want to improve.' },
    { start: 45, end: 50, speaker: 'Chen', text: 'Me too. English is important for our future.' },
    { start: 50, end: 55, speaker: 'Interviewer', text: "That's great! Are you enjoying the city?" },
    { start: 55, end: 60, speaker: 'Anna', text: 'Yes! The city is beautiful.' },
    { start: 60, end: 65, speaker: 'Chen', text: 'I agree. The people are very friendly here.' },
    { start: 65, end: 70, speaker: 'Interviewer', text: 'Thank you for talking with us. Good luck with your studies!' },
    { start: 70, end: 75, speaker: 'Anna and Chen', text: 'Thank you!' }
  ],
