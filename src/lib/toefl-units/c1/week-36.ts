...
export const C1_W${UNIT_ID}_BLOCK1: Exercise = {
  ...
  type: 'practice_set',
  title: 'C1 Level Mock Exam 2',
  explanation: 'Advanced C1 intensive practice for C1 Level Mock Exam 2.',
  questions: [
    {
      id: genId(LEVEL, UNIT_ID, 'b1', 1),
      type: 'multiple-choice',
      question: 'During a C1 level C1 Level Mock Exam 2, the primary objective is:',
...
export const C1_WEEK_36 = createToeflUnit(
  'toefl-c1-w36',
  'Week 36: C1 Level Mock Exam 2',
  'Ultimate preparation phase for the TOEFL iBT at C1 mastery level.',
  ['Execute C1 Level Mock Exam 2 with total accuracy', 'Analyze complex patterns in mock exams', 'Finalize elite-level exam strategies'],
