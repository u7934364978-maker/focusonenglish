...
export const C1_W${UNIT_ID}_BLOCK1: Exercise = {
  ...
  title: '',
  explanation: 'Advanced C1 production focusing on .',
  questions: [
    {
      id: genId(LEVEL, UNIT_ID, 'b1', 1),
      type: 'multiple-choice',
      question: 'To attain a score of 28+ in , a student must demonstrate:',
...
export const C1_WEEK_13 = createToeflUnit(
  'toefl-c1-w13',
  'Week 13: ',
  'Mastering  at C1 level with focus on sophistication and precision.',
  ['Perfect the delivery of  responses', 'Integrate complex ideas with academic flair', 'Maintain high accuracy under strict time constraints'],
