...
const s2 = {
  ...
  transcript: `In today's lecture, we're going to explore the basics of renewable energy and its potential impact on global power consumption. Renewable energy refers to energy sources that are naturally replenished, such as wind, solar, and hydroelectric power. These sources stand in contrast to fossil fuels like coal and oil, which are finite and contribute significantly to environmental pollution. 

First, let us discuss solar energy. It is harnessed using photovoltaic cells which convert sunlight into electricity. These cells are becoming more efficient and affordable, making solar power one of the most promising renewable energy sources worldwide. Many countries with abundant sunlight are investing heavily in solar farms.

Next, we have wind energy, captured by wind turbines. These machines convert kinetic energy from the wind into mechanical power, which can then be used for electricity. Wind farms are most effective in areas with high, consistent wind speeds.

Hydroelectric power, generated by the movement of water through dams, is one of the oldest and most widely used forms of renewable energy. It harnesses the gravitational force of falling or flowing water to produce electricity. While hydroelectricity plays a major role in global electricity supply, it can disrupt aquatic ecosystems and river dynamics.

Finally, I want to mention geothermal energy, which exploits heat from the Earth's interior. This type of energy is especially useful in regions with volcanic activity. Although it holds vast potential, its development is limited due to high initial costs and location-specific constraints.

To sum up, the transition to renewable energy is vital for reducing carbon emissions and combating climate change. Each type of renewable energy has its own advantages and challenges, but together they offer a path towards a more sustainable future.`,
  questions: [
  {
    ...
    "options": [
      ...
      "Energy sources naturally replenished",
      "Nuclear power plants",
      "Energy sources that never run out"
    ],
    "correctAnswer": "Energy sources naturally replenished",
    "explanation": "Las fuentes de energía renovable son aquellas que se reponen naturalmente.",
    "context": "Renewable energy refers to energy sources that are naturally replenished, such as wind, solar, and hydroelectric power.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 2),
    "type": "multiple-choice",
    "question": "What is used to harness solar energy?",
    "options": [
      "Wind turbines",
      "Hydroelectric dams",
      "Photovoltaic cells",
    ...
    "explanation": "Las células fotovoltaicas son utilizadas para convertir la luz solar en electricidad.",
    "context": "Solar energy is harnessed using photovoltaic cells which convert sunlight into electricity.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 3),
    "type": "multiple-choice",
    "question": "In which areas are wind farms most effective?",
    "options": [
      "Where there are many hills",
      "In regions with abundant rainfall",
      "Where wind speeds are high and consistent",
      "In urban areas with tall buildings"
    ],
    "correctAnswer": "Where wind speeds are high and consistent",
    "explanation": "Las granjas eólicas son más efectivas en áreas con alta velocidad de viento constante.",
    "context": "Wind farms are most effective in areas with high, consistent wind speeds.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 4),
    "type": "multiple-choice",
    "question": "How is hydroelectric power generated?",
    "options": [
      "By solar panels",
      "By running wind turbines in water",
      "By the gravitational force of falling or flowing water",
      "By harnessing heat from the Earth's interior"
    ],
    "correctAnswer": "By the gravitational force of falling or flowing water",
    "explanation": "La energía hidroeléctrica se genera utilizando la fuerza gravitacional del agua en movimiento.",
    "context": "Hydroelectric power is generated by the movement of water through dams, harnessing the gravitational force of falling or flowing water to produce electricity.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 5),
    "type": "multiple-choice",
    "question": "What is the main challenge of geothermal energy?",
    "options": [
      "It requires a lot of water",
      "It has high initial costs and location-specific constraints",
      "It depends on the sunlight",
      "It disrupts the wind patterns"
    ],
    "correctAnswer": "It has high initial costs and location-specific constraints",
    "explanation": "La energía geotérmica enfrenta retos debido a sus altos costos iniciales y restricciones de ubicación.",
    "context": "Geothermal energy holds vast potential, but its development is limited due to high initial costs and location-specific constraints.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 6),
    "type": "multiple-choice",
    "question": "What is one benefit of solar energy?",
    "options": [
      "It requires a lot of water",
      "It is cheap and the panels last forever",
      "Panels are becoming more efficient and affordable",
      "It is only effective during the night"
    ],
    "correctAnswer": "Panels are becoming more efficient and affordable",
    "explanation": "Los paneles solares están volviéndose más eficientes y asequibles.",
    "context": "Photovoltaic cells are becoming more efficient and affordable, making solar power one of the most promising renewable energy sources worldwide.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 7),
    "type": "multiple-choice",
    "question": "What is a disadvantage of hydroelectric power?",
    "options": [
      "It disturbs aquatic ecosystems and river dynamics",
      "It produces a lot of pollution",
      "It relies heavily on fossil fuels",
      "It cannot be generated all year round"
    ],
    "correctAnswer": "It disturbs aquatic ecosystems and river dynamics",
    "explanation": "La energía hidroeléctrica puede afectar los ecosistemas acuáticos y la dinámica de los ríos.",
    "context": "While hydroelectricity plays a major role in global electricity supply, it can disrupt aquatic ecosystems and river dynamics.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 8),
    "type": "multiple-choice",
    "question": "What can be said about the status of renewable energy transition?",
    "options": [
      "It has no influence on carbon emissions",
      "It is essential for reducing carbon emissions",
      "It will take centuries to start",
      "It has no advantages or challenges"
    ],
    "correctAnswer": "It is essential for reducing carbon emissions",
    "explanation": "La transición a la energía renovable es vital para reducir las emisiones de carbono.",
    "context": "To sum up, the transition to renewable energy is vital for reducing carbon emissions and combating climate change.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 9),
    "type": "multiple-choice",
    "question": "Which renewable energy source is linked to volcanic activity?",
    "options": [
      "Solar energy",
      "Wind energy",
      "Hydroelectric power",
    ...
    "explanation": "La energía geotérmica explota el calor del interior de la Tierra, relacionada con la actividad volcánica.",
    "context": "Geothermal energy, which exploits heat from the Earth's interior, is especially useful in regions with volcanic activity.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's2', 10),
    "type": "multiple-choice",
    "question": "Why is the transition to renewable energy important?",
    "options": [
      "It makes energy more expensive",
      "It ensures energy is always available",
      "It is critical to combat climate change",
      "It eliminates the need for technology"
    ],
    "correctAnswer": "It is critical to combat climate change",
    "explanation": "La transición a la energía renovable es crítica para combatir el cambio climático.",
    "context": "The transition to renewable energy is vital for reducing carbon emissions and combating climate change.",
    "points": 1
  }
]
};
const s10 = {
  ...
  transcript: `Welcome to Placeholder Shard 10. Today, we'll discuss the importance of time management for students. In the beginning, it's essential to understand that effective time management can lead to improved academic performance. Many students struggle with balancing their workload, leisure, and rest. First, prioritize your tasks by creating a daily schedule. This helps in visualizing the tasks ahead and allows you to allocate time wisely. Next, set specific goals. For instance, complete your assignments in short, focused sessions with breaks in between to enhance productivity. Moreover, don't forget to take care of your health by engaging in regular physical activities. Exercise can greatly reduce stress and improve mental clarity. Finally, always leave some time for reflection and adjustment in your schedule to make it more practical over time.`,
  questions: [
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 1),
    "type": "multiple-choice",
    "question": "According to the transcript, what is one benefit of effective time management?",
    "options": [
    ...
    "correctAnswer": "Improved academic performance",
    "explanation": "La gestión eficaz del tiempo puede conducir a un mejor rendimiento académico, como se menciona en el comienzo del texto.",
    "context": "it's essential to understand that effective time management can lead to improved academic performance",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 2),
    "type": "multiple-choice",
    "question": "What do students often struggle with according to the lecturer?",
    "options": [
    ...
    "correctAnswer": "Balancing workload and leisure",
    "explanation": "Los estudiantes a menudo tienen dificultades para equilibrar su carga de trabajo y el ocio, como se menciona explícitamente.",
    "context": "Many students struggle with balancing their workload, leisure, and rest.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 3),
    "type": "multiple-choice",
    "question": "What tool does the lecturer suggest for prioritizing tasks?",
    "options": [
      "A daily schedule",
      "Priority lists",
      "Social media",
    ...
    "correctAnswer": "A daily schedule",
    "explanation": "Se sugiere crear un horario diario para priorizar las tareas.",
    "context": "First, prioritize your tasks by creating a daily schedule.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 4),
    "type": "multiple-choice",
    "question": "How does the lecturer suggest dividing work sessions?",
    "options": [
      "Short, focused sessions with breaks",
      "Long hours without interruptions",
      "Random tasks throughout the day",
      "Only on the weekends"
    ],
    "correctAnswer": "Short, focused sessions with breaks",
    "explanation": "Se sugiere hacer sesiones cortas y enfocadas con descansos entre ellas para mejorar la productividad.",
    "context": "complete your assignments in short, focused sessions with breaks in between",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 5),
    "type": "multiple-choice",
    "question": "What additional practice is recommended for reducing stress?",
    "options": [
    ...
    "correctAnswer": "Engaging in regular physical activities",
    "explanation": "La activación física ayuda a reducir el estrés y mejorar la claridad mental.",
    "context": "Exercise can greatly reduce stress and improve mental clarity.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 6),
    "type": "multiple-choice",
    "question": "Why is it important to leave time for reflection in your schedule?",
    "options": [
      "To make the schedule more practical over time",
      "To procrastinate tasks",
      "To avoid activities",
      "To increase stress"
    ],
    "correctAnswer": "To make the schedule more practical over time",
    "explanation": "Dejar tiempo para la reflexión y el ajuste hace que el horario sea más práctico con el tiempo.",
    "context": "leave some time for reflection and adjustment in your schedule to make it more practical over time.",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 7),
    "type": "multiple-choice",
    "question": "What does 'allocate time wisely' imply?",
    "options": [
      "Use time efficiently for different tasks",
      "Spend time only on one activity",
      "Ignore time management",
      "Increase workload"
    ],
    "correctAnswer": "Use time efficiently for different tasks",
    "explanation": "Asignar el tiempo sabiamente implica usarlo de manera eficiente para diferentes tareas.",
    "context": "allows you to allocate time wisely",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 8),
    "type": "multiple-choice",
    "question": "What is the initial step to take for managing time, according to the lecturer?",
    "options": [
    ...
    "correctAnswer": "Creating a daily schedule",
    "explanation": "El primer paso sugerido es crear un horario diario.",
    "context": "First, prioritize your tasks by creating a daily schedule.",
    "points": 1
  },
  {
    ...
    "type": "multiple-choice",
    "question": "What does the lecturer suggest students should not forget?",
    "options": [
    ...
    "correctAnswer": "Taking care of their health",
    "explanation": "El conferencista menciona no olvidar cuidar su salud.",
    "context": "Moreover, don't forget to take care of your health",
    "points": 1
  },
  {
    "id": genId(LEVEL, UNIT_ID, 's10', 10),
    "type": "multiple-choice",
    "question": "What does 'mental clarity' refer to in the context?",
    "options": [
    ...
    "correctAnswer": "Clear thinking ability",
    "explanation": "La 'claridad mental' se refiere a la capacidad de pensar con claridad.",
    "context": "improve mental clarity",
    "points": 1
  }
]
};
