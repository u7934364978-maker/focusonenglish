...
export const C1_U12_BLOCK2: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['agreement', 'promise', 'compromise'],
    ...
    },
    {
      ...
      options: ['stopping', 'finish', 'deadlock'],
    ...
    },
    {
      ...
      options: ['forced', 'obliged', 'binding'],
    ...
    },
    {
      ...
      options: ['giving', 'allowance', 'concession'],
    ...
    },
    {
      ...
      options: ['dealer', 'manager', 'negotiator'],
    ...
    },
    {
      ...
      options: ['angry', 'rude', 'confrontational'],
...
export const C1_U12_BLOCK3: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      explanation: 'Asking for [[opinions|opiniones]] [[encourages|fomenta]] [[collaboration|collaboration]].',
      points: 1
    },
    {
  ...
  questions: [
    {
      ...
      options: ['don\'t entirely', 'am not', 'don\'t'],
    ...
    },
    {
      ...
      options: ['happy with', 'open to', 'good for'],
    ...
    },
    {
      ...
      options: ['reservations', 'bad feelings', 'problems'],
    ...
    },
    {
      ...
      options: ['elaborate', 'talk', 'say more'],
    ...
    },
    {
      ...
      options: ['won\'t', 'might not', 'cannot'],
    ...
    },
    {
      ...
      options: ['somewhat higher', 'more expensive', 'too much'],
    ...
    },
    {
      ...
      options: ['entirely familiar', 'sure', 'clear'],
      correctAnswer: 'entirely familiar',
      explanation: '"Not entirely familiar" is a diplomatic way to admit [[confusion|confusión]].',
      points: 2
    },
    {
      id: genId(UNIT_ID, 'b4', 8),
      type: 'multiple-choice',
      question: '"You must change this." -> "It ___ be [[beneficial|beneficioso]] to [[adjust|ajustar]] this."',
      options: ['might', 'would', 'must'],
      correctAnswer: 'would',
      explanation: 'Using conditional "would" to make a [[request|petición]] less like an [[order|orden]].',
      points: 2
    },
    {
      id: genId(UNIT_ID, 'b4', 9),
      type: 'multiple-choice',
      question: '"This is a waste of time." -> "I wonder if we should ___ our [[approach|enfoque]]."',
      options: ['reconsider', 'change', 'stop'],
      correctAnswer: 'reconsider',
      explanation: '"Reconsider" suggests [[improvement|mejora]] rather than just [[failure|fracaso]].',
      points: 2
    },
    {
      id: genId(UNIT_ID, 'b4', 10),
      type: 'multiple-choice',
      question: '"I hate this contract." -> "I have a few ___ with the [[current|actual]] [[draft|borrador]]."',
      options: ['problems', 'concerns', 'hates'],
      correctAnswer: 'concerns',
      explanation: '"Concerns" is the standard [[business|negocios]] word for [[objections|objeciones]].',
      points: 2
    }
  ]
};
...
export const C1_U12_BLOCK5: Exercise = {
  ...
  explanation: 'Final check of Unit 12 [[concepts|conceptos]].',
  questions: [
    {
      id: genId(UNIT_ID, 'b5', 1),
      type: 'multiple-choice',
      question: 'It ___ appear that we have reached a [[deadlock|punto muerto]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'The [[agreement|acuerdo]] is [[legally|legalmente]] ___.',
      options: ['binding', 'fixed', 'closed'],
      correctAnswer: 'binding',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'Could you ___ on that [[point|punto]] [[further|más]]?',
      options: ['elaborate', 'say', 'tell'],
      correctAnswer: 'elaborate',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'I have some ___ about the [[feasibility|viabilidad]] of this [[plan|plan]].',
      options: ['reservations', 'no-gos', 'bad ideas'],
      correctAnswer: 'reservations',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'We need to [[find|encontrar]] some [[common|común]] ___.',
      options: ['ground', 'place', 'area'],
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'The ___ of the [[talks|charlas]] was [[uncertain|incierto]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'Would you be ___ to [[adjusting|ajustar]] the [[price|precio]]?',
      options: ['open', 'good', 'happy'],
      correctAnswer: 'open',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'It is ___ [[unlikely|improbable]] that we will [[accept|aceptar]].',
      options: ['highly', 'maybe', 'very'],
      correctAnswer: 'highly',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'We made a [[major|importante]] ___ to [[seal|sellar]] the [[deal|trato]].',
      options: ['concession', 'giving', 'help'],
      correctAnswer: 'concession',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: '___ I [[suggest|sugerir]] a [[different|diferente]] [[approach|enfoque]]?',
