...
export const C1_U16_BLOCK1: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['are bound', 'are likely', 'should'],
      correctAnswer: 'are bound',
      explanation: '"Bound to" means something is [[certain|seguro]] to happen or be true.',
      points: 1
    },
    {
      ...
      options: ['unlikely', 'impossible', 'unable'],
...
export const C1_U16_BLOCK3: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['cannot', 'must not', 'might not'],
      correctAnswer: 'cannot',
    ...
    },
    {
      ...
      options: ['need not', 'must not', 'should not'],
...
export const C1_U16_BLOCK4: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['mustn\'t', 'don\'t have to', 'should not'],
    ...
    },
    {
      ...
      options: ['didn\'t need', 'needn\'t', 'mustn\'t'],
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'We ___ better [[leave|irnos]] before the [[rush|hora]] [[hour|punta]].',
...
export const C1_U16_BLOCK5: Exercise = {
  ...
  explanation: 'Final check of Unit 16 [[concepts|conceptos]].',
  questions: [
    {
      id: genId(UNIT_ID, 'b5', 1),
      type: 'multiple-choice',
      question: 'He ___ have [[arrived|llegado]] by now, surely.',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'You ___ have [[told|dicho]] me you were [[allergic|alérgico]].',
      options: ['might', 'should', 'must'],
      correctAnswer: 'should',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'They ___ to [[arrive|llegar]] at [[any|cualquier]] [[moment|momento]].',
      options: ['are due', 'are liable', 'are supposed'],
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'It ___ have been his [[brother|hermano]] you saw.',
      options: ['should', 'might', 'can'],
      correctAnswer: 'might',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'You ___ to [[check|revisar]] the [[details|detalles]].',
      options: ['must', 'should', 'ought'],
      correctAnswer: 'ought',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'I ___ [[need|necesitar]] your [[help|ayuda]] [[later|más tarde]].',
      options: ['might', 'must', 'should'],
      correctAnswer: 'might',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'It ___ be [[midnight|medianoche]] [[already|ya]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'We ___ as well [[pay|pagar]] now.',
      options: ['must', 'might', 'should'],
      correctAnswer: 'might',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'You ___ to have [[called|llamado]].',
      options: ['ought', 'must', 'should'],
      correctAnswer: 'ought',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'She ___ have been [[informed|informada]].',
      options: ['must', 'might', 'should'],
      correctAnswer: 'should',
