...
export const C1_U17_BLOCK2: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'I can\'t [[make|hacer]] ___ out what he is [[saying|diciendo]].',
      options: ['take', 'make', 'give'],
      correctAnswer: 'make',
...
export const C1_U17_BLOCK4: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: 'day',
      explanation: '"Call it a day" means to [[stop|parar]] [[working|trabajar]] for the day.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b4', 10),
      type: 'multiple-choice',
      question: 'She has [[bigger|más grande]] ___ to [[fry|freír]].',
      options: ['meat', 'fish', 'eggs'],
      correctAnswer: 'fish',
      explanation: '"Bigger fish to fry" means having more [[important|importantes]] things to do.',
      points: 1
    }
  ]
};
...
// ============================================
// BLOCK 5: UNIT 17 REVIEW (10 items)
// ============================================
export const C1_U17_BLOCK5: Exercise = {
  id: `c1-u${UNIT_ID}-b5`,
  type: 'vocabulary',
  title: 'Unit 17 Review',
  grammarPoint: 'Phrasal Verbs & Idioms',
  explanation: 'Final check of Unit 17 [[concepts|conceptos]].',
  questions: [
    {
      id: genId(UNIT_ID, 'b5', 1),
      type: 'multiple-choice',
      question: 'We need to [[iron|planchar]] ___ the [[final|finales]] [[details|detalles]].',
      options: ['out', 'up', 'off'],
      correctAnswer: 'out',
      explanation: 'Resolving minor issues.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 2),
      type: 'multiple-choice',
      question: 'They [[fell|cayeron]] ___ after a big [[fight|pelea]].',
      options: ['out', 'off', 'down'],
      correctAnswer: 'out',
      explanation: 'To stop being friends.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 3),
      type: 'multiple-choice',
      question: 'I [[ran|corrí]] ___ her in the [[street|calle]].',
      options: ['into', 'over', 'on'],
      correctAnswer: 'into',
      explanation: 'To meet by chance.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 4),
      type: 'multiple-choice',
      question: 'He [[gets|se sale]] ___ with [[everything|todo]].',
      options: ['away', 'off', 'out'],
      correctAnswer: 'away',
      explanation: 'Avoid punishment.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 5),
      type: 'multiple-choice',
      question: 'It\'s not [[rocket|cohete]] ___.',
      options: ['science', 'math', 'art'],
      correctAnswer: 'science',
      explanation: 'Not complicated.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 6),
      type: 'multiple-choice',
      question: 'She is feeling under the ___.',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'Let\'s [[pencil|lápiz]] ___ a [[meeting|reunión]].',
      options: ['in', 'on', 'up'],
      correctAnswer: 'in',
      explanation: 'Make a tentative appointment.',
      points: 1
    },
    {
      id: genId(UNIT_ID, 'b5', 8),
      type: 'multiple-choice',
      question: 'I can\'t [[put|poner]] ___ with him.',
      options: ['up', 'down', 'off'],
      correctAnswer: 'up',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'The [[deal|trato]] [[fell|cayó]] ___.',
      options: ['through', 'out', 'off'],
      correctAnswer: 'through',
      explanation: 'Failed plan.',
      points: 1
    },
    {
      ...
      correctAnswer: 'bush',
      explanation: 'Avoid the topic.',
      points: 1
    }
  ]
};

export const unit17 = createC1Unit(
  'c1-u17',
  'Phrasal Verbs & Idioms',
  'Expand your vocabulary with advanced phrasal verbs and idiomatic expressions for professional and social contexts.',
  ['Use phrasal verbs in professional and social settings', 'Master three-part phrasal verbs', 'Incorporate common idioms into natural speech'],
  [
