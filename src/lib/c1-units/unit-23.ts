...
export const C1_U23_BLOCK1: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['Even so', 'Albeit', 'Whatever'],
    ...
    },
    {
      ...
      options: ['Whatever', 'However', 'Whenever'],
    ...
    },
    {
      ...
      options: ['Despite', 'In spite', 'Regardless'],
    ...
    },
    {
      ...
      options: ['Instead', 'Still', 'Nevertheless'],
    ...
    },
    {
      ...
      options: ['While', 'Notwithstanding', 'Albeit'],
      correctAnswer: 'While',
  ...
  questions: [
    {
      ...
      options: ['Instead', 'Conversely', 'Still'],
    ...
    },
    {
      ...
      options: ['Moreover', 'Furthermore', 'By contrast'],
    ...
    },
    {
      ...
      options: ['despite', 'whereas', 'nevertheless'],
    ...
    },
    {
      ...
      options: ['Contrary', 'Unlike', 'Different'],
  ...
  questions: [
    {
      ...
      options: ['already', 'actually', 'indeed'],
    ...
    },
    {
      ...
      options: ['Instead', 'Indeed', 'Actually'],
      correctAnswer: 'Instead',
    ...
    },
    {
      ...
      options: ['at all', 'too much', 'enough'],
    ...
    },
    {
      ...
      options: ['moreover', 'nonetheless', 'furthermore'],
    ...
    },
    {
      ...
      options: ['However', 'Actually', 'Mind you'],
    ...
    },
    {
      ...
      options: ['That said', 'In fact', 'As a result'],
    ...
    },
    {
      ...
      options: ['Furthermore', 'Conversely', 'Moreover'],
      correctAnswer: 'Conversely',
...
export const C1_U23_BLOCK4: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['Despite', 'Regardless', 'Notwithstanding'],
      correctAnswer: 'Notwithstanding',
