...
export const C1_U3_BLOCK1: Exercise = {
 ...
 'If she ___ so [[stubborn|terca]], she would have admitted her mistake.',       'We would be on the plane now if we ___ the train.',
 'If I ___ you were coming, I would have baked a [[cake|pastel]].',  'If they ___ more careful, they wouldn\'t be in this [[mess|lío]] now.',       'If he ___ all his money, he could buy that car today.',
      'If I ___ better English, I would have got the job.',
 'If she ___ her [[passport|pasaporte]], she would be in Paris now.',  'If we ___ that house, we would be much [[wealthier|más ricos]] today.',  'If I ___ to work today, I would have gone to the [[beach|playa]] yesterday.'     ][i],
    options: [
      ['studied', 'would study', 'had studied'],
      ['were not', 'would not be', 'had not been'],
      ['had not missed', 'missed', 'don\'t miss'],
      ['knew', 'would know', 'had known'],
      ['had been', 'were', 'have been'],
      ['did not spend', 'had not spent', 'won\'t spend'],
      ['had spoken', 'will speak', 'spoke'],
      ['has not lost', 'had not lost', 'lost'],
      ['had not bought', 'would not buy', 'didn\'t buy'],
      ['did not have', 'would not have', 'had not had']
    ][i],
    correctAnswer: [
      'had studied',
      'were not',
...
export const C1_U3_BLOCK2: Exercise = {
 ...
 explanation: 'In formal English, "[[inversion|inversión]] can replace if.',   questions: Array.from({ length: 10 }, (_, i) => ({
    id: genId(UNIT_ID, 'b2', i + 1),
    type: 'multiple-choice',
    question: [
 '___ you need any further [[assistance|asistencia]], please let us know.',       '___ I to win the lottery, I would travel the world.',
      '___ he known about the meeting, he would have attended.',
 '___ it not for your help, I wouldn\'t have [[succeeded|tenido éxito]].',  '___ you change your mind, the [[offer|oferta]] is still open.',       '___ I been in your position, I would have done the same.',
 '___ we to lose the contract, the company would be in [[trouble|problemas]].',       '___ she arrived on time, we wouldn\'t have started without her.',
 '___ you require more information, "[[consult|consulte]] our website.',       '___ it not been for the rain, we would have gone for a walk.'
    ][i],
    options: [
      ['Would', 'Should', 'Had'],
      ['Were', 'If', 'Had'],
...
export const C1_U3_BLOCK3: Exercise = {
 ...
 explanation: 'Use words like unless provided supposing to express [[conditions|condiciones]].',   questions: Array.from({ length: 10 }, (_, i) => ({
 ...
 'I\'ll take an [[umbrella|paraguas]] ___ it rains.',       'We\'ll have the party indoors ___ the weather is bad.',
    ...
    options: [
      ...
      ['unless', 'if', 'provided'],
      ['Supposing', 'In case', 'Assuming'],
      ['unless', 'as long as', 'even if'],
      ['Whether', 'Otherwise', 'Supposing'],
      ['unless', 'in case', 'provided'],
      ['unless', 'otherwise', 'in the event that'],
      ['Assuming', 'Whether', 'In case'],
      ['whether', 'unless', 'otherwise'],
...
export const C1_U3_BLOCK5: Exercise = {
 ...
 explanation: 'Vocabulary related to [[likelihood|probabilidad]] and danger.',   questions: Array.from({ length: 10 }, (_, i) => ({
 ...
 'The project is [[fraught|lleno]] with ___ .',       'We need to assess the ___ before we proceed.',
    ...
    options: [
      ...
      ['safe', 'stable', 'precarious'],
      ['danger', 'risk', 'point'],
      ['clear', 'distinct', 'vague'],
      ['nearly', 'just', 'almost']
    ][i],
    correctAnswer: [
      'likelihood',
