...
export const C1_U22_BLOCK1: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['insisted', 'conceded', 'denied'],
    ...
    },
    {
      ...
      options: ['requested', 'reminded', 'refuted'],
    ...
    },
    {
      ...
      options: ['complained', 'boasted', 'confessed'],
    ...
    },
    {
      ...
      options: ['speaks', 'mentions', 'highlights'],
    ...
    },
    {
      ...
      options: ['refused', 'denied', 'rejected'],
    ...
    },
    {
      ...
      options: ['warned', 'promised', 'threatened'],
...
export const C1_U22_BLOCK2: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['of losing', 'to lose', 'for losing'],
    ...
    },
    {
      ...
      options: ['on passing', 'for passing', 'to pass'],
    ...
    },
    {
      ...
      options: ['to pay', 'on paying', 'for paying'],
    ...
    },
    {
      ...
      options: ['for being', 'to be', 'of being'],
    ...
    },
    {
      ...
      options: ['for stealing', 'of stealing', 'to steal'],
...
export const C1_U22_BLOCK3: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['to not touch', 'not to touch', 'not touch'],
...
export const C1_U22_BLOCK4: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['to have escaped', 'to escape', 'escaped'],
    ...
    },
    {
      ...
      options: ['alleged', 'claimed', 'reported'],
    ...
    },
    {
      ...
      options: ['conceded', 'alleged', 'suggested'],
      correctAnswer: 'alleged',
    ...
    },
    {
      ...
      options: ['resigning', 'to resign', 'to be resigning'],
    ...
    },
    {
      ...
      options: ['announced', 'said', 'highlighted'],
