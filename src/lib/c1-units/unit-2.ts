...
export const C1_U2_BLOCK2: Exercise = {
  ...
  questions: Array.from({ length: 10 }, (_, i) => ({
    ...
    options: [
      ...
      ['howled', 'sang', 'whispered'],
      ['muttered', 'said', 'shouted'],
      ['shattered', 'broke', 'ended'],
      ['peered', 'looked', 'saw'],
      ['lapped', 'hit', 'pushed'],
      ['treaded', 'walked', 'ran'],
      ['spread', 'went', 'came'],
      ['roared', 'started', 'jumped']
    ][i],
    correctAnswer: [
      'crept',
      'gritted',
...
export const C1_U2_BLOCK5: Exercise = {
  ...
  questions: Array.from({ length: 10 }, (_, i) => ({
    ...
    options: [
      ['had we started', 'we had started', 'did we start'],
      ['alive', 'living', 'vibrant'],
      ['is thought', 'thinks', 'was thinking'],
      ['will have been', 'will be', 'are'],
      ['Having finished', 'Finished', 'Finishing'],
      ['murmur', 'sound', 'noise'],
      ['glanced', 'looked', 'saw'],
      ['quite', 'so', 'such'],
