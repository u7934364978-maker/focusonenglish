...
export const C1_U15_BLOCK3: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['Nevertheless', 'Furthermore', 'Moreover'],
...
export const C1_U15_BLOCK4: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      explanation: '"No sooner" requires inversion.',
      points: 2
    },
    {
      id: genId(UNIT_ID, 'b4', 10),
      type: 'fill-blank',
      question: 'It might rain. Take an umbrella. (LEST) \n Take an umbrella ___ it should rain.',
      correctAnswer: 'lest',
      explanation: '"Lest" expresses [[purpose|propósito]] (to prevent).',
      points: 2
    }
  ]
};
...
// ============================================
// BLOCK 5: CONJUNCTIONS IN FORMAL TEXT (10 items)
// ============================================
export const C1_U15_BLOCK5: Exercise = {
  id: `c1-u${UNIT_ID}-b5`,
  type: 'vocabulary',
  title: 'Linking Words in Formal Essays',
  grammarPoint: 'Mixed Review',
  explanation: 'Choose the most [[appropriate|apropiado]] [[linker|conector]] for a [[formal|formal]] [[context|contexto]].',
  questions: [
    {
      id: genId(UNIT_ID, 'b5', 1),
      type: 'multiple-choice',
      question: 'The [[study|estudio]] has [[limitations|limitaciones]]. ___, it provides [[valuable|valiosa]] [[insights|percepciones]].',
      options: ['Be that as it may', 'Anyway', 'So'],
      correctAnswer: 'Be that as it may',
      explanation: '"Be that as it may" is a very formal [[concessive|concesivo]] phrase.',
      points: 1
    },
    {
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'The [[economy|economía]] is [[stagnant|estancada]]. ___, [[unemployment|desempleo]] is [[rising|subiendo]].',
      options: ['Furthermore', 'Too', 'Next'],
      correctAnswer: 'Furthermore',
      explanation: 'Formal way to add information.',
      points: 1
    },
    {
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'He is [[competent|competente]]. ___, he lacks [[vision|visión]].',
      options: ['By contrast', 'However', 'Instead'],
      correctAnswer: 'However',
      explanation: 'Standard formal contrast.',
      points: 1
    },
    {
...
export const unit15: Lesson = createC1Unit(
  'c1-u15',
  'Advanced Conjunctions & Linking Words',
  'Polishing your writing with formal subordinating conjunctions, correlative pairs, and adverbial connectors.',
  ['Use formal conjunctions like inasmuch as and albeit', 'Apply correlative conjunctions with parallel structure', 'Create logical flow in formal writing'],
  [
