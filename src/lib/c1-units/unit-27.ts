  ...
  questions: [
    {
      ...
      type: 'fill-blank',
      question: '___ (Each) of the [[members|miembros]] was [[given|dado]] a [[gift|regalo]].',
      correctAnswer: 'Each',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '___ (Every) [[single|único]] [[person|persona]] was [[there|allí]].',
      correctAnswer: 'Every',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '[[All|Toda]] the ___ (information) we [[received|recibimos]] was [[useful|útil]].',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'They [[spent|pasaron]] the ___ (whole) [[day|día]] [[working|trabajando]].',
      correctAnswer: 'whole',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '___ (Both) [[sides|lados]] [[agreed|acordaron]] to the [[deal|trato]].',
      correctAnswer: 'Both',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '___ (Neither) of the [[two|dos]] [[options|opciones]] is [[good|buena]].',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'You can [[take|tomar]] ___ (either) of the [[buses|autobuses]].',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '___ (None) of the [[students|estudiantes]] [[passed|pasó]].',
      correctAnswer: 'None',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: '___ (Few) [[people|personas]] [[know|saben]] the [[truth|verdad]].',
      correctAnswer: 'Few',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'We have ___ (little) [[hope|esperanza]] [[left|restante]].',
...
export const C1_U27_BLOCK2: Exercise = {
  ...
  questions: [
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'There isn\'t a ___ (shred) of [[evidence|evidencia]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'He has a ___ (speck) of [[dust|polvo]] on his [[coat|abrigo]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'I have a ___ (grain) of [[truth|verdad]] in my [[story|historia]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'A ___ (drop) of [[water|agua]] was on the [[leaf|hoja]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'He gave me a ___ (piece) of [[advice|consejo]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'A ___ (fit) of [[anger|ira]] [[seized|se apoderó]] him.',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'She felt a ___ (pang) of [[guilt|culpa]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'A ___ (gust) of [[wind|viento]] [[blew|sopló]] her [[hat|sombrero]] off.',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'A ___ (blade) of [[grass|hierba]] was [[green|verde]].',
  ...
  questions: [
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (flock) of [[birds|pájaros]] [[flew|voló]] [[south|sur]].',
      correctAnswer: 'flock',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (herd) of [[elephants|elefantes]] crossed the [[plain|llanura]].',
      correctAnswer: 'herd',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (pack) of [[wolves|lobos]] [[howled|aulló]].',
      correctAnswer: 'pack',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (school) of [[fish|peces]] [[swam|nadó]] [[past|por delante]].',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (swarm) of [[bees|abejas]] [[attacked|atacó]].',
      correctAnswer: 'swarm',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (pride) of [[lions|leones]] was [[resting|descansando]].',
      correctAnswer: 'pride',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (batch) of [[cookies|galletas]] was in the [[oven|horno]].',
      correctAnswer: 'batch',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (bunch) of [[keys|llaves]] was on the [[table|mesa]].',
      correctAnswer: 'bunch',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (set) of [[rules|reglas]] must be [[followed|seguidas]].',
      correctAnswer: 'set',
    ...
    },
    {
      ...
      type: 'fill-blank',
      question: 'A ___ (series) of [[events|eventos]] [[led|llevó]] to the [[war|guerra]].',
  ...
  questions: [
    {
      ...
      type: 'multiple-choice',
      question: 'There was ___ (hardly) any [[food|comida]] [[left|restante]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'Not a ___ (single) [[soul|alma]] was [[seen|vista]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'She has ___ (next) to [[no|ninguna]] [[money|dinero]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'There is ___ (little) [[point|sentido]] in [[waiting|esperar]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: '___ (Scarcely) any [[progress|progreso]] has been [[made|hecho]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'They have ___ (precious) [[little|poca]] [[time|tiempo]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'I saw ___ (few) if [[any|algunos]] [[birds|pájaros]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: 'There is ___ (barely) any [[hope|esperanza]].',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      question: '___ (Neither) of them [[came|vino]].',
