/**
 * Índice de las 6 lecciones de la Unidad 29 (C2).
 */
...
import { UNIT_29_LESSON_6_SPEAKING } from './unit-29-lesson-6-speaking';
...
export const UNIT_29_LESSONS = {
  ...
  speaking: UNIT_29_LESSON_6_SPEAKING,
} as const;
