/**
 * Índice de las 6 lecciones de la Unidad 7 (C2).
 */
...
import { UNIT_7_LESSON_6_SPEAKING } from './unit-7-lesson-6-speaking';
...
export const UNIT_7_LESSONS = {
  ...
  speaking: UNIT_7_LESSON_6_SPEAKING,
} as const;
