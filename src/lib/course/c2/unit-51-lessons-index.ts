/**
 * Índice de las 6 lecciones de la Unidad 51 (C2).
 */
...
import { UNIT_51_LESSON_6_SPEAKING } from './unit-51-lesson-6-speaking';
...
export const UNIT_51_LESSONS = {
  ...
  speaking: UNIT_51_LESSON_6_SPEAKING,
} as const;
