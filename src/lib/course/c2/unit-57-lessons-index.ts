/**
 * Índice de las 6 lecciones de la Unidad 57 (C2).
 */
...
import { UNIT_57_LESSON_6_SPEAKING } from './unit-57-lesson-6-speaking';
...
export const UNIT_57_LESSONS = {
  ...
  speaking: UNIT_57_LESSON_6_SPEAKING,
} as const;
