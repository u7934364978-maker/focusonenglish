/**
 * Índice de las 6 lecciones de la Unidad 38 (C2).
 */
...
import { UNIT_38_LESSON_6_SPEAKING } from './unit-38-lesson-6-speaking';
...
export const UNIT_38_LESSONS = {
  ...
  speaking: UNIT_38_LESSON_6_SPEAKING,
} as const;
