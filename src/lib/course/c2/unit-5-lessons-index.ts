/**
 * Índice de las 6 lecciones de la Unidad 5 (C2).
 */
...
import { UNIT_5_LESSON_6_SPEAKING } from './unit-5-lesson-6-speaking';
...
export const UNIT_5_LESSONS = {
  ...
  speaking: UNIT_5_LESSON_6_SPEAKING,
} as const;
