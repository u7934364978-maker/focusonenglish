...
export const UNIT_25_EXERCISES: Exercise[] = [
  // --- SUB-TOPIC 1: Grammar: Mixed Conditionals (Type 2/3) - Past result of present condition (1-10) ---
  {
    ...
    content: {
      items: [
        {
          front: "Mixed Conditional (Type 2/3)",
          back: "Si fuera... habría hecho...",
          pronunciation: "/mɪkst kənˈdɪʃ.ən.əl/",
          example: "If I were smarter, I would have passed the test.",
          explanation: "Se usa para un resultado pasado de una condición presente o permanente."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 2: Grammar: Mixed Conditionals (Type 3/2) - Present result of past condition (11-20) ---
  {
    ...
    content: {
      items: [
        {
          front: "Mixed Conditional (Type 3/2)",
          back: "Si hubiera hecho... ahora sería...",
          pronunciation: "/mɪkst kənˈdɪʃ.ən.əl/",
          example: "If I had won the lottery, I would be rich now.",
          explanation: "Se usa para un resultado presente de una condición o acción pasada."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 3: Grammar: Mixed Conditionals - Future result of past condition (21-30) ---
  {
    ...
    content: {
      items: [
        {
          front: "Mixed Conditional (Past -> Future)",
          back: "Si hubiera pasado... pasaría en el futuro...",
          pronunciation: "/mɪkst kənˈdɪʃ.ən.əl/",
          example: "If I hadn't missed the flight, I would be flying to Paris tomorrow.",
          explanation: "Se usa para un resultado futuro de una condición o acción pasada."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 4: Grammar: Mixed Conditionals - Review (31-40) ---
  {
    ...
    content: {
      items: [
        {
          front: "Mixed Conditionals Summary",
          back: "Combinación de tiempos según el contexto.",
          pronunciation: "/mɪkst kənˈdɪʃ.ən.əl ˈsʌm.ər.i/",
          example: "If I were you, I would have gone.",
          explanation: "Repaso de todas las formas de condicionales mixtos."
        }
      ]
    }
  },
      ...
      items: [
        {
          ...
          back: "Tomar una decisión",
          pronunciation: "/meɪk ə dɪˈsɪʒ.ən/",
          example: "It was hard to make a decision.",
          explanation: "Proceso de elegir entre varias opciones."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 6: Vocabulary: Hypothetical Outcomes (51-60) ---
  {
    ...
    content: {
      items: [
        {
          front: "Outcome",
          back: "Resultado / Desenlace",
          pronunciation: "/ˈaʊt.kʌm/",
          example: "The outcome of the meeting was positive.",
          explanation: "El resultado final de una situación o evento."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 7: Grammar: Alternatives to 'If' (Suppose, Imagine, Otherwise) (61-70) ---
  {
    ...
    content: {
      items: [
        {
          front: "Alternatives to 'If'",
          back: "Supón que... / Imagina que... / De lo contrario...",
          pronunciation: "/səˈpəʊz / ɪˈmædʒ.ɪn / ˈʌð.ə.waɪz/",
          example: "Imagine you had won. Otherwise, we would be lost.",
          explanation: "Palabras que pueden sustituir a 'if' o complementar estructuras condicionales."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 8: Grammar: Inversions in Conditionals (Had I known, Were I you) (71-80) ---
  {
    ...
    content: {
      items: [
        {
          front: "Inversion in Conditionals",
          back: "De haber sabido... / Si yo fuera...",
          pronunciation: "/ɪnˈvɜː.ʒən/",
          example: "Had I known, I would have helped. Were I you, I'd go.",
          explanation: "Forma más formal de condicionales donde se elimina el 'if' y se invierte el sujeto y el verbo."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 9: Phrasal Verbs with 'If' contexts (81-90) ---
  {
    ...
    content: {
      items: [
        {
          front: "Turn out",
          back: "Resultar ser / Acabar siendo",
          pronunciation: "/tɜːn aʊt/",
          example: "It turned out that he was right.",
          explanation: "Se usa para hablar de resultados inesperados o finales."
        }
      ]
    }
  },
  ...
  // --- SUB-TOPIC 10: General Review & Scenarios (91-100) ---
  {
    ...
    content: {
      items: [
        {
          front: "Conditionals Review",
          back: "Repaso de todas las formas condicionales.",
          pronunciation: "/kənˈdɪʃ.ən.əlz rɪˈvjuː/",
          example: "If I had known, I would be happy now.",
          explanation: "Resumen de situaciones hipotéticas en pasado, presente y futuro."
        }
      ]
    }
  },
