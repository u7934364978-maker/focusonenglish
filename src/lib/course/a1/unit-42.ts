...
export const UNIT_42_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    "content": {
      ...
      "questions": [
        {
          "question": "[[I|Yo]] [[go|go]] [[to|a/para]] [[work|trabajo/trabajar]] ([[en|en]]) _______ [[bus|bus]].",
          "options": [
            "[[are|están]]",
            "[[is|es]]",
            "[[by|by]]"
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "The train  arrives at 9 AM.",
    "content": {
      "title": "Practica la Gramática",
      "instructions": "Completa la oración con la opción correcta.",
      "questions": [
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "I  drive a car.",
    "content": {
      "title": "Practica la Gramática",
      "instructions": "Completa la oración con la opción correcta.",
      "questions": [
        {
          "question": "[[I|Yo]] ([[conducir|conducir]]) _______ [[a|un/una]] [[car|car]].",
          "options": [
            "[[is|es]]",
            "[[drive|drive]]",
            "[[are|están]]"
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "She  rides a bicycle.",
    "content": {
      "title": "Practica la Gramática",
      "instructions": "Completa la oración con la opción correcta.",
      "questions": [
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "The train is faster than the bus.",
    "content": {
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "I don't like flying by plane.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "He rides a motorbike to work.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "Let's take a taxi.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
      "correctSentence": "[[Let's|Let's]] [[take|take]] [[a|un/una]] [[taxi|taxi]].",
      "words": [
        "[[Let's|Let's]]",
        "[[taxi|taxi]].",
        "[[take|take]]",
  ...
  },
  {
    ...
    "topic": "Transport",
    "difficulty": "easy",
    "transcript": "The boat is in the harbor.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
