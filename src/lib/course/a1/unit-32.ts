...
export const UNIT_32_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    "content": {
      "title": "short_writing",
      "instructions": "Traduce: 'Mi hobby es viajar.'",
      "questions": [
        {
  ...
  },
  {
    ...
    "topic": "vocabulary",
    "difficulty": "medium",
    "transcript": "Photography",
    "content": {
      "title": "flashcard",
      "instructions": "Estudia el hobby:",
      "questions": [
        {
  ...
  },
  {
    ...
    "content": {
      "title": "true_false",
      "instructions": "¿Es gramaticalmente correcto? 'They don't like playing tennis.'",
      "questions": [
        {
  ...
  },
  {
    ...
    "content": {
      ...
      "instructions": "Clasifica los verbos según si necesitan 'play' o 'go':",
      "questions": [
        {
