  ...
  },
  {
    ...
    content: {
      ...
      questions: [{
        ...
        options: ['[[Two|Dos]] [[friends|amigos]] [[talk|hablan]] [[about|de]] [[work|trabajo]].', '[[Two|Dos]] [[friends|amigos]] [[describe|describen]] [[family|familia]] [[members|miembros]]: [[hair|pelo]], [[eyes|ojos]], [[height|altura]], [[age|edad]].', '[[A|Una]] [[lesson|clase]] [[at|en]] [[school|el colegio]].'],
        correctAnswer: 1,
        explanation: 'Diálogo sobre descripción física de la hermana de Tom y del hermano de Lisa.',
      }],
    },
    topicName: 'Listening',
  },
