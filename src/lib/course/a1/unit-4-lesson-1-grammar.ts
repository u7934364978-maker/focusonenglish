      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: '"[[This|Esto]]" [[is|es]] [[singular|singular]] and [[near|cerca]]. [[Correct|Correcto]]: [[This is a ruler.|Esto es una regla.]]',
        },
      ],
    },
    topicName: 'Grammar',
      ...
      questions: [
        {
          ...
          correctAnswer: 2,
          explanation: '"[[Those|Esos]]" [[is|es]] plural and [[far|lejos]]. [[Correct|Correcto]]: [[Those are pens.|Esos son bolígrafos.]]',
        },
      ],
    },
    topicName: 'Grammar',
      ...
      questions: [
        {
          ...
          options: ['[[True|Verdadero]]', '[[False|Falso]]'],
          correctAnswer: 'True',
          explanation: '[[True|Verdadero]]. [[This → These|Este → Estos]] ([[near, plural|cerca]]) and [[book → books|libro → libros]] ([[regular plural|regular]]).',
        },
      ],
    },
    topicName: 'Grammar',
