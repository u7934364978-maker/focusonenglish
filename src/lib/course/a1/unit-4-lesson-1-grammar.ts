...
export const UNIT_4_LESSON_1_GRAMMAR: Exercise[] = [
      ...
      questions: [
        {
          ...
          explanation: '"[[These|Estos]]" [[refers to|se refiere a]] [[things|cosas]] [[near|cerca]]; [[plural|plural]].',
        },
      ],
    },
    topicName: 'Grammar',
  ...
  },
  {
    ...
    content: {
      ...
      questions: [
        {
          question: '[[Choose|Elige]] [[the correct|el correcto]] ([[plural, far|plural, lejos]]):',
          options: [
          ...
          correctAnswer: 2,
          explanation: '"[[Those|Esos]]" [[is|es]] [[plural|plural]] [[and|y]] [[far|lejos]]. [[Correct|Correcto]]: [[Those are pens.|Esos son bolígrafos.]]',
        },
      ],
    },
    topicName: 'Grammar',
      ...
      questions: [
        {
          ...
          options: ['[[True|Verdadero]]', '[[False|Falso]]'],
          correctAnswer: 'True',
          explanation: '[[True|Verdadero]]. [[This → These|Este → Estos]] ([[near, plural|cerca, plural]]) [[and|y]] [[book → books|libro → libros]] ([[regular plural|plural regular]]).',
        },
      ],
    },
    topicName: 'Grammar',
