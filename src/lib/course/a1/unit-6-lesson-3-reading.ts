...
export const UNIT_6_LESSON_3_READING: Exercise[] = [
  ...
  },
  {
    ...
    content: {
      ...
      instructions: INSTRUCTIONS,
      questions: [{
        question: '[[What|Sobre]] [[does|qué]] [[Carlos|Carlos]] [[talk|habla]] [[about|habla]] [[in|en]] [[the|el]] [[text|texto]]?',
        options: ['[[His family (mother, father, sister, brother, grandparents).|Su familia (madre, padre, hermana, hermano, abuelos).]]', '[[His job.|Su trabajo.]]', '[[Valencia.|Valencia.]]'],
        correctAnswer: 0,
        explanation: 'Carlos presenta a su familia.',
      }],
    },
    topicName: 'Reading',
  },
