      ...
      questions: [
        {
          ...
          explanation: '[[Regular|Regular]] plural: [[book|libro]] → [[books|libros]] (+s).',
        },
      ],
    },
    topicName: 'Writing',
      ...
      questions: [
        {
          ...
          explanation: '"[[These|Estos]]" [[is|se usa]] [[for|para]] plural [[near|cerca]]: "[[These are my pens.|Estos son mis bolígrafos.]]"',
        },
      ],
    },
    topicName: 'Writing',
