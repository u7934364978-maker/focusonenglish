...
export const UNIT_45_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    "content": {
      ...
      "text": "[[Hi! I am in Rome|¡Hola! Estoy en Roma]] [[on holiday.|de vacaciones.]] [[The weather is|El tiempo es]] [[beautiful and sunny.|hermoso y soleado.]] [[Today, I am visiting|Hoy estoy visitando]] [[the Colosseum|el Coliseo]] [[with a tourist guide.|con un guía turístico.]] [[It is amazing!|¡Es increíble!]] [[There are a lot of people here,|Hay mucha gente aquí,]] [[so the city is very crowded.|así que la ciudad está muy abarrotada.]] [[Tomorrow, I am going to see|Mañana voy a ver]] [[the Vatican Museum|el Museo Vaticano]] [[and buy some souvenirs|y comprar algunos recuerdos]] [[for my family.|para mi familia.]] [[I am also eating|También estoy comiendo]] [[a lot of local pasta|mucha pasta local]] [[and ice cream.|y helado.]] [[It is delicious!|¡Está delicioso!]] [[I am having a|Lo estoy pasando]] [[wonderful time.|maravillosamente.]] [[See you soon!|¡Nos vemos pronto!]] [[Best, David.|Saludos, David.]]",
      "questions": [
        {
  ...
  },
  {
    ...
    "content": {
      ...
      "text": "[[Holidays are great|Las vacaciones son geniales]] [[for relaxing.|para relajarse.]] [[Some people like going|A algunas personas les gusta ir]] [[to the beach|a la playa]] [[to swim and have fun|para nadar y divertirse]] [[in the sun.|bajo el sol.]] [[Other people prefer|Otras personas prefieren]] [[the mountains|las montañas]] [[for hiking and fresh air.|para hacer senderismo y aire puro.]] [[When you visit a city,|Cuando visitas una ciudad,]] [[you can go sightseeing.|puedes hacer turismo.]] [[It is important|Es importante]] [[to have a map|tener un mapa]] [[and a camera.|y una cámara.]] [[You should also try|También deberías probar]] [[the local food|la comida local]] [[because it is usually delicious.|porque suele estar deliciosa.]] [[Don't forget to buy|No olvides comprar]] [[a brochure|un folleto]] [[at the tourist information office.|en la oficina de información turística.]] [[It has a lot of|Tiene mucha]] [[useful information|información útil]] [[about the monuments and museums.|sobre los monumentos y museos.]] [[Enjoy your vacation!|¡Disfruta de tus vacaciones!]]",
      "questions": [
        {
