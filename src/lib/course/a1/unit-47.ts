...
export const UNIT_47_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    "content": {
      ...
      "text": "[[Emergency services are|Los servicios de emergencia son]] [[very important.|muy importantes.]] [[If there is a fire,|Si hay un incendio,]] [[you must call|debe llamar a]] [[the fire station.|la estación de bomberos.]] [[If you have an accident|Si tiene un accidente]] [[or feel very sick,|o se siente muy enfermo,]] [[you need an ambulance|necesita una ambulancia]] [[to go to the hospital.|para ir al hospital.]] [[At the hospital,|En el hospital,]] [[doctors and nurses|los médicos y enfermeros]] [[can help you.|pueden ayudarle.]] [[If you lose|Si pierde]] [[your passport or wallet,|su pasaporte o cartera,]] [[you should go to|debería ir a]] [[the police station|la comisaría]] [[to report it.|para denunciarlo.]] [[In some situations,|En algunas situaciones,]] [[you can find a|puede encontrar una]] [[lost and found office.|oficina de objetos perdidos.]] [[Always remember|Recuerde siempre]] [[the emergency phone number|el número de teléfono de emergencia]] [[of the country|del país]] [[you are visiting.|que está visitando.]] [[Stay calm|Mantenga la calma]] [[and ask for help|y pida ayuda]] [[if you need it.|si la necesita.]]",
      "questions": [
        {
  ...
  },
  {
    ...
    "content": {
      ...
      "text": "[[Last week, I had a problem.|La semana pasada tuve un problema.]] [[I was in a|Estaba en un]] [[big shopping mall|gran centro comercial]] [[and I lost|y perdí]] [[my mobile phone.|mi teléfono móvil.]] [[I was very worried|Estaba muy preocupado]] [[because all my contacts|porque todos mis contactos]] [[are there.|están allí.]] [[I went to|Fui a ver a]] [[the security guard|el guardia de seguridad]] [[and asked for help.|y pedí ayuda.]] [[He took me to|Me llevó a]] [[the lost and found office.|la oficina de objetos perdidos.]] [[I described my phone:|Describí mi teléfono:]] [[it is black|es negro]] [[and has a red case.|y tiene una funda roja.]] [[The assistant checked|El asistente miró en]] [[a drawer and found it!|un cajón y ¡lo encontró!]] [[Someone found it|Alguien lo encontró]] [[near the cinema|cerca del cine]] [[and brought it there.|y lo trajo allí.]] [[I was so happy!|¡Estaba tan feliz!]] [[It is important to know|Es importante saber]] [[that most big places|que la mayoría de los sitios grandes]] [[have a system|tienen un sistema]] [[for lost items.|para objetos perdidos.]] [[If you lose something,|Si pierde algo,]] [[don't panic.|no se asuste.]]",
      "questions": [
        {
