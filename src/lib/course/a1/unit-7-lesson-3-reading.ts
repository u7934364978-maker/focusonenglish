...
export const UNIT_7_LESSON_3_READING: Exercise[] = [
  ...
  },
  {
    ...
    content: {
      ...
      instructions: INSTRUCTIONS,
      questions: [{
        question: '[[What|De]] [[colour|qué]] [[is|es]] [[the|el]] [[friend\'s|de la amiga]] [[hair|pelo]] [[in|en]] [[the|el]] [[text|texto]]?',
        options: ['[[Brown.|Castaño.]]', '[[Black.|Negro.]]', '[[Blonde.|Rubio.]]'],
        correctAnswer: 0,
        explanation: 'Descripción: pelo castaño largo.',
      }],
    },
    topicName: 'Reading',
  },
