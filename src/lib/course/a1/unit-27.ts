...
export const UNIT_27_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    "topic": "Pets & Animals",
    "difficulty": "easy",
    "transcript": "She  has two cats.",
    "content": {
      "title": "Practica la Gramática",
      "instructions": "Completa la oración con la opción correcta.",
      "questions": [
        {
          "question": "[[She|Ella]] ([[tener|tener]]) _______ [[two|two]] [[cats|cats]].",
          "options": [
            "[[has|has]]",
            "[[is|es]]",
            "[[are|están]]"
  ...
  },
  {
    ...
    "topic": "Pets & Animals",
    "difficulty": "easy",
    "transcript": "My dog's name is Max.",
    "content": {
  ...
  },
  {
    ...
    "topic": "Pets & Animals",
    "difficulty": "easy",
    "transcript": "I have a gold fish.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
      "correctSentence": "[[I|Yo]] [[have|tener/haber]] [[a|un/una]] [[gold|gold]] [[fish|fish]].",
      "words": [
        "[[fish|fish]].",
        "[[gold|gold]]",
        "[[a|un/una]]",
  ...
  },
  {
    ...
    "topic": "Pets & Animals",
    "difficulty": "easy",
    "transcript": "The horse is very fast.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
  ...
  },
  {
    ...
    "topic": "Pets & Animals",
    "difficulty": "easy",
    "transcript": "Lions live in Africa.",
    "content": {
      "title": "Construcción de Oraciones",
      "instructions": "Ordena las palabras para formar una oración correcta.",
