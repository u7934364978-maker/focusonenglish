/**
 * Unidad 43 — Lección 3: Comprensión lectora (Present Perfect: Just, Already, Yet)
...
const READING_TRANSCRIPT = `[[I|Yo]] [[have|he]] [[just|acabo]] [[woken up|despertado]] [[and|y]] [[I|yo]] [[am|estoy]] [[very|muy]] [[tired|cansado]]. [[I|Yo]] [[have|he]] [[already|ya]] [[had|tomado]] [[my|mi]] [[coffee|café]] [[but|pero]] [[I|yo]] [[have not|no he]] [[eaten|comido]] [[breakfast|desayuno]] [[yet|aún]]. [[My|Mi]] [[sister|hermana]] [[has|ha]] [[just|acaba]] [[arrived|llegado]] [[from|de]] [[work|trabajo]]. [[She|Ella]] [[has|ha]] [[already|ya]] [[finished|terminado]] [[her|sus]] [[report|informe]] [[for|para]] [[today|hoy]]. [[We|Nosotros]] [[have not|no hemos]] [[had|tenido]] [[lunch|almuerzo]] [[yet|aún]] [[because|porque]] [[we|nosotros]] [[are|estamos]] [[waiting|esperando]] [[for|a]] [[our|nuestro]] [[parents|padres]]. [[They|Ellos]] [[have|han]] [[just|acaban]] [[left|salido]] [[the|del]] [[supermarket|supermercado]].`;

const INSTRUCTIONS = 'Lee el texto de abajo. Después responde las preguntas.';

const QUESTIONS = [
  { question: '[[What|Qué]] [[has|ha]] [[the|el]] [[writer|autor]] ____ ____ ____?', options: ['[[just woken up|acabo de despertar]]', '[[just eaten|acabo de comer]]', '[[just left|acabo de salir]]', '[[just finished|acabo de terminar]]'], correctAnswer: 0, explanation: '[[He|Él]] [[says|dice]] "[[I have just woken up|Acabo de despertar]]".' },
  { question: '[[Has|Ha]] [[the|el]] [[writer|autor]] ____ ____ ____ ____?', options: ['[[had coffee already|tomado café ya]]', '[[had breakfast already|tomado desayuno ya]]', '[[had lunch already|tomado almuerzo ya]]', '[[had dinner already|tomado cena ya]]'], correctAnswer: 0, explanation: '[[He|Él]] [[says|dice]] "[[I have already had my coffee|Ya he tomado mi café]]".' },
  { question: '[[Has|Ha]] [[the|el]] [[writer|autor]] ____ ____ ____ ____?', options: ['[[eaten breakfast yet|comido desayuno aún]]', '[[not eaten breakfast yet|no comido desayuno aún]]', '[[eaten lunch yet|comido almuerzo aún]]', '[[finished work yet|terminado trabajo aún]]'], correctAnswer: 1, explanation: '[[He|Él]] [[says|dice]] "[[I have not eaten breakfast yet|No he comido desayuno aún]]".' },
  ...
  { question: '[[Where|Dónde]] [[have|han]] ____ ____ ____ ____ ____?', options: ['[[the parents just left|los padres acaban de salir]]', '[[the parents just arrived|los padres acaban de llegar]]', '[[the parents just eaten|los padres acaban de comer]]', '[[the parents just slept|los padres acaban de dormir]]'], correctAnswer: 0, explanation: '[[The|La]] [[text|texto]] [[says|dice]] "[[They have just left the supermarket|Acaban de salir del supermercado]]".' },
  ...
  { question: '[[The|El]] [[main|principal]] [[topic|tema]] [[of|del]] [[text|texto]] [[is|es]]?', options: ['[[Food|Comida]]', '[[Recent actions with just, already, yet|Acciones recientes con just, already, yet]]', '[[Work|Trabajo]]', '[[Travel|Viajes]]'], correctAnswer: 1, explanation: '[[The|El]] [[text|texto]] [[uses|usa]] [[just|just]], [[already|already]] [[and|y]] [[yet|yet]].' },
  { question: '[[How|Cómo]] [[does|está]] [[the|el]] [[writer|autor]] ____ ____?', options: ['[[feel|sintiendo]]', '[[Very tired|Muy cansado]]', '[[Very happy|Muy feliz]]', '[[Very hungry|Muy hambriento]]'], correctAnswer: 1, explanation: '[[He|Él]] [[says|dice]] "[[I am very tired|Estoy muy cansado]]".' },
  { question: '[[The|El]] [[writer|autor]] [[uses|usa]] [[Present Perfect|Presente Perfecto]] [[with|con]] [[just|just]], [[already|already]] [[and|y]] [[yet|yet]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[These|Estas]] [[words|palabras]] [[go|van]] [[with|con]] [[Present Perfect|Presente Perfecto]].' },
  { question: '[[Where|Dónde]] [[did|estuvieron]] [[the|los]] ____ ____ ____ ____?', options: ['[[parents go|padres]] [[to the supermarket|en el supermercado]]', '[[parents go|padres]] [[to work|en el trabajo]]', '[[parents go|padres]] [[to school|en la escuela]]', '[[parents go|padres]] [[to the beach|en la playa]]'], correctAnswer: 0, explanation: '[[They|Ellos]] [[have just left the supermarket|acaban de salir del supermercado]].' },
];
