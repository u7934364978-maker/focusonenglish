/**
 * Unidad 22 B2 — Lección 3: Comprensión lectora (Animals)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Animals|Animals]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
