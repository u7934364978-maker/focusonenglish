/**
 * Unidad 7 B2 — Lección 3: Comprensión lectora (Family)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Family|Family]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
