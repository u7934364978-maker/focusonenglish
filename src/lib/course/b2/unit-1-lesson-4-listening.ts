...
const QUESTIONS = [
  ...
  { question: '[[James|James]] [[gave|dio]] [[the talk|la charla]] [[successfully|con éxito]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[He says|Dice]] "[[I finally did it|finalmente lo hice]]".' },
  { question: '[[James|James]] [[is proud|está orgulloso]] [[of his progress|de su progreso]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[He says|Dice]] "[[I feel proud of my progress|me siento orgulloso de mi progreso]]".' },
