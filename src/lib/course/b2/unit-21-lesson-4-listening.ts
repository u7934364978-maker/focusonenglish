/**
 * Unidad 21 B2 — Lección 4: Comprensión auditiva (Health and fitness)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Health and fitness|Health and fitness]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
