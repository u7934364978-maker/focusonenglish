/**
 * Unidad 24 B2 — Lección 4: Comprensión auditiva (Places)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Places|Places]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
