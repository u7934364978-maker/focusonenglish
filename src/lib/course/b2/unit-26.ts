...
export const UNIT_26_EXERCISES: Exercise[] = [
  // 1-10: Grammar - Negative Inversion (Never, Seldom, Rarely)
  {
    ...
    content: {
      ...
      question: "Never ___ such a crime.",
      options: ["have I seen", "I have seen", "did I saw"],
  ...
  },
  {
    ...
    content: {
      ...
      question: "Seldom ___ such evidence.",
      options: ["do we find", "we find", "did we found"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "Rarely ___ so helpful.",
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "Little ___ about the trap.",
      options: ["did they know", "they knew", "had they know"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "Hardly ___ speaking when he was interrupted.",
      options: ["had the witness started", "the witness had started", "did the witness started"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "Scarcely ___ when the alarm went off.",
      options: ["had I arrived", "I had arrived", "did I arrive"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "No sooner ___ than the police arrived.",
  ...
  },
  {
    ...
    content: {
      ...
      options: ["should you open", "you should open", "shall you open"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "In no way ___ this action.",
      options: ["can we justify", "we can justify", "could we justify"],
  ...
  },
  {
    ...
    content: {
      title: "Negative Inversion",
      instructions: "Choose the correct word order.",
      question: "Not only ___ a thief, but he was also a liar.",
      options: ["was he", "he was", "had he been"],
  ...
  // 11-20: Vocabulary - Types of Crimes
  {
    ...
    content: {
      ...
      instructions: "Fill in the blank with the correct crime.",
      question: "___ (Burglary) is the act of entering a building illegally to steal.",
  ...
  },
  {
    ...
    content: {
      ...
      question: "___ (Shoplifting) is stealing from a store during business hours.",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "He was arrested for ___ (fraud), specifically financial deception.",
      correctAnswer: "fraud",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Vandalism) is the deliberate destruction of public or private property.",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Arson) is the criminal act of deliberately setting fire to property.",
      correctAnswer: "Arson",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Theft) is the action or crime of stealing.",
      correctAnswer: "Theft",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Smuggling) is the illegal movement of goods or people out of or into a country.",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Kidnapping) is taking someone away by force, often for ransom.",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Blackmail) is demanding money from someone in return for not revealing secrets.",
  ...
  },
  {
    ...
    content: {
      title: "Types of Crime",
      instructions: "Fill in the blank.",
      question: "___ (Assault) is a physical attack or threat of attack on a person.",
  ...
  // 21-30: Vocabulary - Legal System
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (witness) gave a clear statement in court.",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (jury) reached a verdict of guilty.",
      correctAnswer: "jury",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (defendant) was acquitted of all charges.",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (lawyer) prepared the defense for the trial.",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (judge) handed down a tough sentence.",
      correctAnswer: "judge",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "There was not enough ___ (evidence) to convict him.",
  ...
  },
  {
    ...
    content: {
      title: "The Court",
      instructions: "Fill in the blank.",
      question: "The ___ (trial) lasted for three weeks.",
      correctAnswer: "trial",
  ...
  },
  {
    ...
    content: {
      title: "Punishment",
      instructions: "Fill in the blank.",
      question: "He was released on ___ (parole) after serving half his sentence.",
  ...
  },
  {
    ...
    content: {
      title: "Punishment",
      instructions: "Fill in the blank.",
      question: "The ___ (fine) for speeding is quite expensive here.",
      correctAnswer: "fine",
  ...
  },
  {
    ...
    content: {
      title: "Punishment",
      instructions: "Fill in the blank.",
      question: "___ (Imprisonment) is the state of being held in prison.",
  ...
  // 31-40: Vocabulary - Phrasal Verbs & Expressions
  {
    ...
    content: {
      ...
      question: "He managed to ___ with the crime because there were no witnesses.",
      options: ["get away", "get through", "get over"],
  ...
  },
  {
    ...
    content: {
      title: "Expressions",
      instructions: "Choose the correct phrasal verb.",
      question: "The police are ___ the matter of the missing jewels.",
      options: ["looking into", "looking after", "looking for"],
  ...
  },
  {
    ...
    content: {
      ...
      question: "The thief was caught ___, right in the middle of stealing the car.",
  ...
  },
  {
    ...
    content: {
      title: "Expressions",
      instructions: "Choose the correct phrasal verb.",
      question: "They ___ the warehouse last night and stole several computers.",
      options: ["broke into", "broke up", "broke out"],
  ...
  },
  {
    ...
    content: {
      title: "Expressions",
      instructions: "Choose the correct phrasal verb.",
      question: "The suspect eventually ___ himself up to the police.",
      options: ["gave", "turned", "made"],
      correctAnswer: "gave",
  ...
  },
  {
    ...
    content: {
      ...
      question: "He can't get that job because he has a criminal ___.",
      options: ["record", "list", "book"],
  ...
  },
  {
    ...
    content: {
      ...
      question: "The case was ___ of court due to lack of evidence.",
      options: ["thrown out", "put away", "taken off"],
  ...
  },
  {
    ...
    content: {
      title: "Expressions",
      instructions: "Choose the correct idiom.",
      question: "He was convicted and is now behind ___.",
      options: ["bars", "doors", "walls"],
      correctAnswer: "bars",
  ...
  },
  {
    ...
    content: {
      title: "Expressions",
      instructions: "Choose the correct phrasal verb.",
      question: "The police decided to ___ him off with just a warning.",
      options: ["let", "set", "get"],
      correctAnswer: "let",
  ...
  },
  {
    ...
    content: {
      ...
      question: "He didn't do it; he was ___ by his enemy.",
      options: ["framed", "built", "made"],
  ...
  // 41-50: Word Formation
  {
    ...
    content: {
      ...
      question: "The ___ (CRIME) was caught quickly by the police.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "Vandalism is ___ (LEGAL).",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "The ___ (INVESTIGATE) is still ongoing.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "He received a severe ___ (PUNISH).",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "The ___ (THEFT) was arrested near the scene.",
      correctAnswer: "thief",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "He acted ___ (SUSPECT) throughout the interview.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "His ___ (INNOCENT) was finally proven.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "It was a ___ (VIOLENCE) crime that shocked the community.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "The ___ (BURGLARY) entered through the back window.",
  ...
  },
  {
    ...
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
      question: "He made a ___ (FRAUD) insurance claim.",
