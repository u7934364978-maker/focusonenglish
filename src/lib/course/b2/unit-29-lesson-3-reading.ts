/**
 * Unidad 29 B2 — Lección 3: Comprensión lectora (Mixed topics)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Mixed topics|Mixed topics]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
