/**
 * Unidad 30 B2 — Lección 3: Comprensión lectora (Review)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Review|Review]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
