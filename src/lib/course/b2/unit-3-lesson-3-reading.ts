...
const QUESTIONS = [
  ...
  { question: '[[The person|La persona]] [[suggests|sugiere]] [[signing up for more workshops|apuntarse a más talleres]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[I suggest signing up for more workshops|sugiero apuntarse a más talleres]]".' },
  ...
  { question: '[[The person|La persona]] [[agreed|acordó]] [[to consider|considerar]] [[the gap year|el año sabático]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[I agreed to consider it|acordé considerarlo]]".' },
