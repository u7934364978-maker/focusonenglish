...
const QUESTIONS = [
  ...
  { question: '[[The person|La persona]] [[took up|empezó]] [[photography|fotografía]] [[last year|el año pasado]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The colleague invited him to join last year|el compañero le invitó a unirse el año pasado]].' },
