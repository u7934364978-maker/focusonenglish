...
const QUESTIONS = [
  ...
  { question: '[[Emma|Emma]] [[will benefit from|se beneficiará de]] [[flexible hours|el horario flexible]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[She says|Dice]] "[[I think I will benefit from it|creo que me beneficiaré de ello]]".' },
  { question: '[[By 2029|Para 2029]] [[Emma|Emma]] [[will have been|habrá estado]] [[in the sector|en el sector]] [[for|durante]] [[five years|cinco años]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'False', explanation: '[[False|Falso]]. [[She says|Dice]] "[[eight years|ocho años]]".' },
  ...
  { question: '[[Emma|Emma]] [[is|está]] [[already|ya]] [[working|trabajando]] [[at the new company|en la nueva empresa]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'False', explanation: '[[False|Falso]]. [[She says|Dice]] "[[I am going to join a new company in March|voy a unirme a una nueva empresa en marzo]]".' },
];
