/**
 * Unidad 22 B2 — Lección 4: Comprensión auditiva (Animals)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Animals|Animals]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
