/**
 * Unidad 26 B2 — Lección 3: Comprensión lectora (Work (extended))
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Work (extended)|Work (extended)]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
