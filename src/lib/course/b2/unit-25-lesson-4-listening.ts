/**
 * Unidad 25 B2 — Lección 4: Comprensión auditiva (Review)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Review|Review]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
