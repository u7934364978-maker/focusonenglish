/**
 * Unidad 29 B2 — Lección 4: Comprensión auditiva (Mixed topics)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Mixed topics|Mixed topics]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
