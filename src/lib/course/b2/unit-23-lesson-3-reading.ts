/**
 * Unidad 23 B2 — Lección 3: Comprensión lectora (Communication)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Communication|Communication]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
