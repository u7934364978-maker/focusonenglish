...
const QUESTIONS = [
  ...
  { question: '[[Tom|Tom]] [[finished submitting|terminó de entregar]] [[his thesis|su tesis]] [[last week|la semana pasada]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[He says|Dice]] "[[I finished submitting my thesis last week|terminé de entregar mi tesis la semana pasada]]".' },
  { question: '[[Tom|Tom]] [[managed to pass|logró aprobar]] [[the viva|la defensa]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[He says|Dice]] "[[I managed to pass the viva|logré aprobar la defensa]]".' },
  ...
  { question: '[[The advisor|El asesor]] [[asked|pidió]] [[Tom to consider|a Tom que considerara]] [[a PhD|un doctorado]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[He says|Dice]] "[[My advisor asked me to consider doing a PhD|mi asesor pidió que considerara hacer un doctorado]]".' },
];
