/**
 * Unidad 27 B2 — Lección 4: Comprensión auditiva (Travel (extended))
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Travel (extended)|Travel (extended)]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
...
const QUESTIONS = [
  ...
  { question: '[[The speaker|El hablante]] [[believes|cree]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
  ...
  { question: '[[The speaker|El hablante]] [[states|afirma]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
  ...
  { question: '[[According to|Según]] [[the speaker|el hablante]], ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
  ...
  { question: '[[The main idea|La idea principal]] [[is|es]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
  ...
  { question: '[[The speaker|El hablante]] [[mentions|menciona]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
  ...
  { question: '[[The speaker|El hablante]] [[implies|implica]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The speaker says|El hablante dice]].' },
