...
const QUESTIONS = [
  ...
  { question: '[[The person\'s passport and visa|El pasaporte y visa de la persona]] [[were valid|eran válidos]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[My passport and visa were valid|mi pasaporte y visa estaban válidos]]".' },
