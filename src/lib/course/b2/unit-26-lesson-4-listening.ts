/**
 * Unidad 26 B2 — Lección 4: Comprensión auditiva (Work (extended))
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Work (extended)|Work (extended)]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
