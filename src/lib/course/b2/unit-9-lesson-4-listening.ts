/**
 * Unidad 9 B2 — Lección 4: Comprensión auditiva (Environment)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Environment|Environment]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
