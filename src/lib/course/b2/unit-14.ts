...
export const UNIT_14_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    content: {
      ...
      options: ["applying", "apply", "to apply"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["to commute", "commute", "commuting"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["practice", "practicing", "to practice"],
  ...
  // 11-20: Grammar - Change in Meaning
  {
    ...
    content: {
      ...
      options: ["[[locking|haber cerrado]]", "[[to lock|cerrar]]", "[[locked|cerró]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[to lock|cerrar]]", "[[locking|cerrado]]", "[[locked|cerró]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[smoking|fumar]]", "[[to smoke|fumar (para)]]", "[[smoke|fumar (base)]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[telling|haberle contado]]", "[[to tell|lamentar contar]]", "[[told|contado]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[restarting|reiniciar (experimento)]]", "[[to restart|reiniciar (esfuerzo)]]", "[[restart|reinicia]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[to open|abrir (esfuerzo)]]", "[[opening|abrir (experimento)]]", "[[open|abierto]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[meeting|haber conocido]]", "[[to meet|olvidar conocer]]", "[[met|conocí]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[to send|enviar]]", "[[sending|enviado]]", "[[sent|envió]]"],
      correctAnswer: "to send",
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[to inform|informarle]]", "[[informing|haberle informado]]", "[[informed|informado]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[to become|convertirse (después)]]", "[[becoming|continuar siendo]]", "[[become|llegar a ser]]"],
  ...
  // 21-30: Vocabulary - Career Paths
  {
    ...
    content: {
      ...
      options: ["[[ladder|escalafón / escalera]]", "[[stairs|escaleras]]", "[[elevator|ascensor]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[skills|habilidades]]", "[[tools|herramientas]]", "[[ideas|ideas]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[sabbatical|año sabático]]", "[[vacation|vacaciones]]", "[[break|descanso]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[prospects|perspectivas]]", "[[problems|problemas]]", "[[papers|papeles]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[resume|currículum]]", "[[letter|carta]]", "[[book|libro]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[seasoned|experimentada]]", "[[new|nueva]]", "[[young|joven]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[advancement|avance]]", "[[stoppage|parada]]", "[[delay|retraso]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[skill|habilidad]]", "[[desk|escritorio]]", "[[room|habitación]]"],
      correctAnswer: "skill",
  ...
  },
  {
    ...
    content: {
      ...
      options: ["[[severance|indemnización]]", "[[gift|regalo]]", "[[prize|premio]]"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["talking", "selling", "negotiation"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["Rigidity", "Adaptability", "Speed"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["Proficiency", "Interest", "Liking"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["Followership", "Solitude", "Leadership"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["It is free", "Jobs are easy", "Skills become obsolete fast", "It is fun"],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["I am writing to express my interest in...", "Hello!", "I want the job."],
  ...
  },
  {
    ...
    content: {
      ...
      options: ["I need better skills.", "I am keen to expand my skill set.", "I will improve.", "I want to learn more."],
