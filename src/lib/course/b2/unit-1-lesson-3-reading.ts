...
const QUESTIONS = [
  ...
  { question: '[[The person|La persona]] [[set|estableció]] [[three goals|tres metas]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[I set myself three goals|me establecí tres objetivos]]".' },
  { question: '[[The person|La persona]] [[thinks|cree]] [[it is too late|que es demasiado tarde]] [[to begin|para empezar]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'False', explanation: '[[False|Falso]]. [[The text says|El texto dice]] "[[it is never too late to begin|nunca es demasiado tarde para empezar]]".' },
  ...
  { question: '[[The text|El texto]] [[implies|implica]] [[that|que]] [[it is never too late|nunca es demasiado tarde]] [[to begin|para empezar]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[it is never too late to begin|nunca es demasiado tarde para empezar]]".' },
  ...
  { question: '[[The person|La persona]] [[used to|solía]] [[stay|quedarse]] [[in|en]] [[their|su]] [[comfort zone|zona de confort]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[I stayed in my comfort zone|me quedaba en mi zona de confort]]".' },
];
