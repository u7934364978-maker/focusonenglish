...
const QUESTIONS = [
  ...
  { question: '[[The person|La persona]] [[expects|espera]] [[to get promoted|ser ascendido]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[I expect to get promoted|espero ser ascendido]]".' },
  ...
  { question: '[[The firm|La firma]] [[is recruiting|está reclutando]] [[new staff|nuevo personal]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[The text says|El texto dice]] "[[we are recruiting new staff|estamos reclutando nuevo personal]]".' },
  ...
  { question: '[[The text|El texto]] [[implies|implica]] [[that|que]] [[the person|la persona]] [[is committed|está comprometido]] [[to|con]] [[the firm|la firma]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'True', explanation: '[[True|Verdadero]]. [[Five years|Cinco años]] [[at the same firm|en la misma firma]] [[shows commitment|muestra compromiso]].' },
