...
const QUESTIONS = [
  ...
  { question: '[[Tom|Tom]] [[took a course on public speaking|tomó un curso de oratoria]] [[before the presentation|antes de la presentación]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 'False', explanation: '[[False|Falso]]. [[He says|Dice]] "[[If only I had taken a course on public speaking first|ojalá hubiera tomado un curso de oratoria primero]]" — [[he did not|no lo hizo]].' },
