/**
 * Unidad 9 B2 — Lección 3: Comprensión lectora (Environment)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Environment|Environment]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
