...
export const UNIT_24_EXERCISES: Exercise[] = [
  // 1-10: Grammar - All-Cleft Sentences
  {
    id: "b2-u24-e1",
    ...
    difficulty: "medium",
    transcript: "I want justice. All I want is justice.",
    content: {
      ...
      translation: "Quiero justicia. -> Todo lo que quiero es justicia.",
      hint: "Everything/Only thing."
    },
    topicName: "Grammar"
  },
  {
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "She did was cry. All she did was cry.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      translation: "Lo que hizo fue llorar. -> Todo lo que hizo fue llorar.",
      hint: "Only action."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "They need is a chance. All they need is a chance.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      options: ["What", "That", "All"],
      correctAnswer: "All",
      explanation: "Emphasizing the sole requirement.",
      translation: "Necesitan una oportunidad. -> Todo lo que necesitan es una oportunidad.",
      hint: "Only requirement."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "I heard was a loud noise. All I heard was a loud noise.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      options: ["That", "All", "What"],
      correctAnswer: "All",
      explanation: "Emphasizing the only thing heard.",
      translation: "Escuché un ruido fuerte. -> Todo lo que escuché fue un ruido fuerte.",
      hint: "Only perception."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "He wants is to be heard. All he wants is to be heard.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      translation: "Quiere ser escuchado. -> Todo lo que quiere es ser escuchado.",
      hint: "Only desire."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "She wrote was a short note. All she wrote was a short note.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      options: ["All", "That", "What"],
      correctAnswer: "All",
      explanation: "Emphasizing the limited output.",
      translation: "Escribió una nota corta. -> Todo lo que escribió fue una nota corta.",
      hint: "Only writing."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We saw was a bird. All we saw was a bird.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      translation: "Vimos un pájaro. -> Todo lo que vimos fue un pájaro.",
      hint: "Only sighting."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "He does is complain. All he does is complain.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      translation: "Solo se queja. -> Todo lo que hace es quejarse.",
      hint: "Repetitive only."
    },
    topicName: "Grammar"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "All I want for Christmas is you.",
    content: {
      title: "All-Cleft Sentences",
      instructions: "Choose the correct word.",
      ...
      translation: "Todo lo que quiero para Navidad eres tú.",
      hint: "Starts with A."
    },
    topicName: "Grammar"
  },

  // 11-20: Grammar - Time, Place, and Reason Clefts
  {
    id: "b2-u24-e11",
    type: "fill-blank",
    level: "B2",
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The reason I am here is to help.",
    content: {
      title: "Reason Clefts",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The time I saw him was last Sunday.",
    content: {
      title: "Time Clefts",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The place we met was in London.",
    content: {
      title: "Place Clefts",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The reason she left was the noise.",
    content: {
      title: "Reason Clefts",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The time the accident happened was at night.",
    content: {
      title: "Time Clefts",
      instructions: "Fill in the missing words.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The place I grew up was a small village.",
    content: {
      title: "Place Clefts",
      instructions: "Fill in the missing words.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The reason they failed was lack of planning.",
    content: {
      title: "Reason Clefts",
      instructions: "Fill in the missing words.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The time I finish work is at 5 PM.",
    content: {
      title: "Time Clefts",
      instructions: "Fill in the missing words.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The place he lives is very quiet.",
    content: {
      title: "Place Clefts",
      instructions: "Fill in the missing words.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "hard",
    transcript: "The reason I am calling is to confirm.",
    content: {
      title: "Reason Clefts",
      instructions: "Fill in the missing words.",
  ...
  // 21-30: Vocabulary - Social Justice Concepts
  {
    id: "b2-u24-e21",
    type: "fill-blank",
    level: "B2",
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We must strive for social justice.",
    content: {
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Human rights are universal.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We need to fight for equality for all.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Economic inequality is a global problem.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Fairness is the foundation of a good society.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We should protect the most vulnerable members of society.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Privilege often goes unnoticed by those who have it.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We must promote inclusion in all areas of life.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Diversity makes our community stronger.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We need to address the root causes of poverty.",
    content: {
      title: "Social Concepts",
      instructions: "Fill in the blank.",
      ...
      hint: "Underlying reasons."
    },
    topicName: "Vocabulary"
  },

  // 31-40: Vocabulary - Inequality and Bias
  {
    id: "b2-u24-e31",
    type: "multiple-choice",
    level: "B2",
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Discrimination is still a reality for many.",
    content: {
      title: "Inequality",
      ...
      options: ["Inclusion", "Fairness", "Discrimination"],
      ...
      translation: "La discriminación sigue siendo una realidad para muchos.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The gender pay gap is a form of inequality.",
    content: {
      title: "Inequality",
      instructions: "Choose the correct term.",
      ...
      translation: "La brecha salarial de género es una forma de desigualdad.",
      hint: "Related to sex/identity."
    },
    topicName: "Vocabulary"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Systemic racism is built into institutions.",
    content: {
      title: "Inequality",
      instructions: "Choose the correct term.",
      ...
      translation: "El racismo sistémico está integrado en las instituciones.",
      hint: "Institutional/Structural."
    },
    topicName: "Vocabulary"
  },
  {
    ...
    content: {
      ...
      translation: "Muchas personas se enfrentan a barreras para la educación.",
      hint: "Obstacles."
    },
    topicName: "Vocabulary"
  },
  ...
  },
  {
    ...
    content: {
      ...
      translation: "Necesitamos superar el estigma social.",
      hint: "Mark of disgrace."
    },
    topicName: "Vocabulary"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Oppression has many forms.",
    content: {
      title: "Inequality",
      instructions: "Choose the correct term.",
      ...
      translation: "La opresión tiene muchas formas.",
      hint: "Cruel/unjust control."
    },
    topicName: "Vocabulary"
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The gap between the rich and poor is widening.",
    content: {
      title: "Inequality",
      instructions: "Choose the correct term.",
      ...
      translation: "La brecha entre ricos y pobres se está ampliando.",
      hint: "Difference/distance."
    },
    topicName: "Vocabulary"
  },
  {
  ...
  // 41-50: Word Formation
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The equality of all people is a basic principle.",
    content: {
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We must fight against injustice.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "Her generosity was inspiring.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The poverty in this area is shocking.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "We need a more inclusive society.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The diversity of the city is its strength.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "He is a very influential speaker on human rights.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The responsibility of the government is clear.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "The vulnerability of children must be protected.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
  ...
  },
  {
    ...
    topic: "Social Justice",
    difficulty: "medium",
    transcript: "She showed great bravery in the face of adversity.",
    content: {
      title: "Word Formation",
      instructions: "Transform the word in brackets.",
