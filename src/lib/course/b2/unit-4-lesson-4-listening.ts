...
const QUESTIONS = [
  ...
  { question: '[[Lisa|Lisa]] [[persuaded|convenció]] [[her friend|a su amigo]] [[to come|a venir]] [[camping|de camping]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[She says|Dice]] "[[I persuaded my friend to come with us|convencí a mi amigo a venir con nosotros]]".' },
  ...
  { question: '[[Lisa|Lisa]] [[would like|le gustaría]] [[the listener to try|que el oyente probara]] [[this pastime|este pasatiempo]].', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[True|Verdadero]]. [[She says|Dice]] "[[I would like you to try this pastime|me gustaría que probaras este pasatiempo]]".' },
];
