/**
 * Unidad 24 B2 — Lección 3: Comprensión lectora (Places)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Places|Places]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
