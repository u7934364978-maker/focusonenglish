/**
 * Unidad 21 B2 — Lección 3: Comprensión lectora (Health and fitness)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Health and fitness|Health and fitness]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
