/**
 * Unidad 6 B2 — Lección 3: Comprensión lectora (Feelings and emotions)
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Feelings and emotions|Feelings and emotions]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
