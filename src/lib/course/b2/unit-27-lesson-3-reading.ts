/**
 * Unidad 27 B2 — Lección 3: Comprensión lectora (Travel (extended))
...
const READING_TRANSCRIPT = `[[Read|Lee]] [[the text|el texto]] [[below|abajo]] [[about|sobre]] [[Travel (extended)|Travel (extended)]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
...
const QUESTIONS = [
  ...
  { question: '[[The author|El autor]] [[believes|cree]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[The text|El texto]] [[states|afirma]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[According to|Según]] [[the text|el texto]], ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[The main idea|La idea principal]] [[is|es]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[The text|El texto]] [[mentions|menciona]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[According to|Según]] [[the text|el texto]], [[the author|el autor]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
  ...
  { question: '[[The text|El texto]] [[implies|implica]] [[that|que]] ____.', options: ['[[True|Verdadero]]', '[[False|Falso]]'], correctAnswer: 0, explanation: '[[The text says|El texto dice]].' },
