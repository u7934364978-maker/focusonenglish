/**
 * Unidad 23 B2 — Lección 4: Comprensión auditiva (Communication)
...
const LISTENING_TRANSCRIPT = `[[Listen|Escucha]] [[to the audio|el audio]] [[about|sobre]] [[Communication|Communication]]. [[Then|Después]] [[answer|responde]] [[the questions|las preguntas]].`;
