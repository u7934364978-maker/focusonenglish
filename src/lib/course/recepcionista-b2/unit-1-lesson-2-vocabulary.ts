...
export const UNIT_1_LESSON_2_VOCABULARY: Exercise[] = [
  {
    ...
    difficulty: 'medium',
    content: {
      title: '[[Hotel Management Vocabulary — Word in Context|Vocabulario de gestión hotelera — Palabra en contexto]]',
      instructions: '[[Choose the word that best completes each sentence. All sentences are from real hotel situations.|Elige la palabra que mejor completa cada frase. Todas las frases son de situaciones reales de hotel.]]',
      questions: [
        {
          question: '[[The general manager checked the ___ every morning: occupancy was at 87% and revenue per room had increased by 12%.|El director general revisaba los ___ cada mañana: la ocupación estaba al 87% y el ingreso por habitación había subido un 12%.]]',
        ...
        {
          question: '[[Our ___ last night was only 62%, which means more than a third of our rooms were empty.|Anoche nuestra ___ de ocupación fue solo del 62%, es decir, más de un tercio de las habitaciones estaban vacías.]]',
        ...
        {
          question: '[[A ___ visited the hotel last week, posing as an ordinary guest to evaluate our service without warning.|Un ___ visitó el hotel la semana pasada, haciéndose pasar por huésped corriente para evaluar nuestro servicio sin avisar.]]',
        ...
        {
          question: '[[The chain\'s ___ require that all front desk staff greet every guest within 30 seconds of arrival.|Los ___ de la cadena exigen que todo el personal de recepción salude a cada huésped en los 30 segundos posteriores a su llegada.]]',
        ...
        {
          question: '[[We compared our ___ per room with the industry average to see if our pricing was competitive.|Comparamos nuestros ___ por habitación con la media del sector para ver si nuestra tarifación era competitiva.]]',
  ...
  },
  {
    ...
    difficulty: 'medium',
    content: {
      title: '[[Hotel Management Vocabulary — Match the Definition|Vocabulario de gestión hotelera — Relaciona con la definición]]',
      instructions: '[[Read each definition and choose the correct vocabulary word.|Lee cada definición y elige la palabra de vocabulario correcta.]]',
      questions: [
        {
          question: '[[A formal examination of a hotel\'s processes, records and practices to check that everything meets required standards.|Examen formal de los procesos, registros y prácticas de un hotel para comprobar que todo cumple los estándares exigidos.]]',
        ...
        {
          question: '[[A standard point of reference used to measure and compare hotel performance against the industry or competitors.|Punto de referencia para medir y comparar el rendimiento del hotel con el sector o la competencia.]]',
        ...
        {
          question: '[[The act of following all rules, regulations and standards required by law or a hotel brand.|Cumplir todas las normas, regulaciones y estándares exigidos por la ley o por la marca hotelera.]]',
        ...
        {
          question: '[[A regular meeting or evaluation session where an employee\'s work, progress and goals are discussed with their manager.|Reunión o sesión de evaluación periódica en la que se comenta con el manager el trabajo, el progreso y los objetivos del empleado.]]',
        ...
        {
          question: '[[A guest\'s written opinion about a hotel stay, usually posted on websites like TripAdvisor or Booking.com.|Opinión escrita de un huésped sobre su estancia, publicada normalmente en sitios como TripAdvisor o Booking.com.]]',
  ...
  },
  {
    ...
    difficulty: 'medium',
    content: {
      title: '[[Hotel Management Vocabulary — Complete the Sentence|Vocabulario de gestión hotelera — Completa la frase]]',
      instructions: '[[Fill in the blank with the correct word from this unit\'s vocabulary: KPI, occupancy rate, revenue per room, brand standards, mystery guest, audit, compliance, benchmark, performance review, online review.|Rellena el hueco con la palabra correcta del vocabulario de esta unidad: KPI, tasa de ocupación, ingresos por habitación, estándares de marca, huésped misterioso, auditoría, cumplimiento, punto de referencia, evaluación de rendimiento, reseña online.]]',
      questions: [
        {
          question: '[[The hotel\'s annual ___ revealed several issues with food safety procedures in the kitchen.|La ___ anual del hotel reveló varios problemas con los procedimientos de seguridad alimentaria en cocina.]]',
          correctAnswer: 'audit',
        ...
        {
          question: '[[Our ___ for this quarter is 78%, compared to 72% in the same period last year.|Nuestra ___ de ocupación de este trimestre es del 78%, frente al 72% del mismo periodo del año pasado.]]',
        ...
        {
          question: '[[Each receptionist has a ___ with the front office manager every six months to discuss targets and progress.|Cada recepcionista tiene una ___ con el jefe de recepción cada seis meses para hablar de objetivos y progreso.]]',
        ...
        {
          question: '[[We use the industry\'s average RevPAR as our ___ to measure whether we are pricing our rooms correctly.|Usamos el RevPAR medio del sector como ___ para ver si estamos fijando bien el precio de las habitaciones.]]',
        ...
        {
          question: '[[A negative ___ on TripAdvisor last week mentioned slow check-in, so we have reviewed our procedures.|Una ___ negativa en TripAdvisor la semana pasada mencionó un check-in lento, así que hemos revisado nuestros procedimientos.]]',
  ...
  },
  {
    ...
    difficulty: 'medium',
    content: {
      title: '[[Hotel Management Vocabulary — Correct Use?|Vocabulario de gestión hotelera — ¿Uso correcto?]]',
      instructions: '[[Decide if the vocabulary word is used correctly in each sentence. If false, think about why and what the correct word should be.|Decide si la palabra del vocabulario se usa correctamente en cada frase. Si es falso, piensa por qué y cuál debería ser la palabra correcta.]]',
      questions: [
        {
          question: '[[\"The mystery guest gave us a perfect score because our receptionist greeted him warmly and offered an upgrade.\" — Is \"mystery guest\" used correctly here?|«El huésped misterioso nos dio la máxima puntuación porque nuestro recepcionista lo saludó con calidez y ofreció una mejora.» — ¿Se usa bien «mystery guest» aquí?]]',
        ...
        {
          question: '[[\"We need to improve our compliance because we only have a 65% occupancy rate this month.\" — Is \"compliance\" used correctly here?|«Tenemos que mejorar nuestro cumplimiento porque solo tenemos un 65% de ocupación este mes.» — ¿Se usa bien «compliance» aquí?]]',
          options: ['[[True|Verdadero]] — [[Correct use|Uso correcto]]', '[[False|Falso]] — [[Incorrect use|Uso incorrecto]]'],
          correctAnswer: 'False',
        ...
        {
          question: '[[\"Our brand standards require that all staff wear a name badge and address guests by their surname.\" — Is \"brand standards\" used correctly here?|«Nuestros estándares de marca exigen que todo el personal lleve identificación y se dirija a los huéspedes por su apellido.» — ¿Se usa bien «brand standards» aquí?]]',
          options: ['[[True|Verdadero]] — [[Correct use|Uso correcto]]', '[[False|Falso]] — [[Incorrect use|Uso incorrecto]]'],
          correctAnswer: 'True',
        ...
        {
          question: '[[\"We ran an audit of our online reviews last month and discovered that guests love our breakfast.\" — Is \"audit\" used correctly here?|«Hicimos una auditoría de nuestras reseñas online el mes pasado y descubrimos que a los huéspedes les encanta nuestro desayuno.» — ¿Se usa bien «audit» aquí?]]',
          options: ['[[True|Verdadero]] — [[Correct use|Uso correcto]]', '[[False|Falso]] — [[Incorrect use|Uso incorrecto]]'],
          correctAnswer: 'True',
        ...
        {
          question: '[[\"Our KPI this quarter is to hire three new receptionists for the summer season.\" — Is \"KPI\" used correctly here?|«Nuestro KPI este trimestre es contratar tres recepcionistas nuevos para la temporada de verano.» — ¿Se usa bien «KPI» aquí?]]',
          options: ['[[True|Verdadero]] — [[Correct use|Uso correcto]]', '[[False|Falso]] — [[Incorrect use|Uso incorrecto]]'],
          correctAnswer: 'False',
