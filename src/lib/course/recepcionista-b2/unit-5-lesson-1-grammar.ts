/*
 * Unit 5 — Proceso de check-in avanzado / Advanced Check-in (B2)
 * Grammar lesson: Present Perfect vs. Past Simple
 * — Presente perfecto vs. pasado simple en contexto profesional —
 */
    ...
    content: {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 0,
          explanation: '[[Past simple passive|Pasiva en pasado simple]] [[because|porque]] "on the 3rd of last month" [[is a specific finished date|es una fecha específica y terminada]]. [[Even in passive|Incluso en pasiva]], [[specific past time references|las referencias a un tiempo pasado específico]] [[require past simple|requieren pasado simple]].',
        },
      ],
    },
    topicName: 'Grammar',
