...
export const UNIT_9_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    content: { title: '[[Speaking|Expresión oral]]: [[Debating Media Issues|Debatir sobre los medios]]', instructions: 'Choose the most appropriate C1 expression to question someone\'s source.',
      questions: [{ question: 'Your debate partner cites a statistic. You want to question the reliability of the source. Which is most appropriate?', options: ['[[Where did you get that from?|¿De dónde sacaste eso?]]', '[[I would be inclined to question the rigour of that particular study — could you speak to the methodology used?|Me inclinaría a cuestionar el rigor de ese estudio en particular; ¿podría hablar sobre la metodología empleada?]]', '[[That\'s not right.|Eso no es correcto.]]'], correctAnswer: 1, explanation: '"I would be inclined to question..." = tentative challenge; "could you speak to the methodology" = sophisticated request for evidence.' }] },
    topicName: 'Speaking',
  },
];
