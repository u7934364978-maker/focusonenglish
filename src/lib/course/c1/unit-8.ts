...
export const UNIT_8_EXERCISES: Exercise[] = [
  {
    ...
    content: { title: '[[Grammar|Gramática]]: [[Fronting and Topicalisation|Fronting y tematización]]', instructions: 'Choose the sentence that uses fronting correctly.',
      questions: [{ question: 'Which sentence correctly uses fronting for emphasis?', options: ['[[These challenges, many communities have faced for decades.|Estos desafíos, muchas comunidades los han enfrentado durante décadas.]]', '[[Many communities have faced for decades these challenges.|Muchas comunidades han enfrentado durante décadas estos desafíos.]]', '[[For decades, these challenges have been faced by many communities.|Durante décadas, estas comunidades han enfrentado estos desafíos.]]'], correctAnswer: 0, explanation: 'Fronting moves the topic to the front: "These challenges, [subject] have [verbed]..."' }] },
    topicName: 'Grammar',
  },
  {
  ...
  {
    id: 'c1-u8-g4', type: 'fill-blank', level: 'C1', topic: 'adverbial-clauses', difficulty: 'hard',
    content: { title: '[[Grammar|Gramática]]: [[Advanced Adverbial Clauses|Cláusulas adverbiales avanzadas]]', instructions: 'Complete with the correct adverbial structure.',
      questions: [{ question: 'Sanctions were imposed _______ _______ ensure compliance with international law.', options: ['[[so as to|con el fin de]]', '[[in order|para]]', '[[so that|para que]]'], correctAnswer: 'so as to', acceptableAnswers: ['so as to', 'in order to'], explanation: '"So as to" / "in order to" = formal purpose clauses at C1 level.' }] },
    topicName: 'Grammar',
  },
  {
    id: 'c1-u8-g5', type: 'multiple-choice', level: 'C1', topic: 'obligation-structures', difficulty: 'hard',
    content: { title: '[[Grammar|Gramática]]: [[Advanced Obligation|Obligación avanzada]]', instructions: 'Choose the most formal obligation structure.',
      questions: [{ question: 'All member states _______ implement the framework within 24 months of ratification.', options: ['[[are required to|están obligados a]]', '[[must to|deben a]]', '[[have must|tienen deben]]'], correctAnswer: 0, explanation: '"Are required to" = formal legal/regulatory obligation language.' }] },
    topicName: 'Grammar',
  },
  {
  ...
  {
    id: 'c1-u8-v4', type: 'fill-blank', level: 'C1', topic: 'global-vocabulary', difficulty: 'hard',
    content: { title: '[[Vocabulary|Vocabulario]]: [[Global Issues|Problemas globales]]', instructions: 'Complete the sentence.',
      questions: [{ question: 'NGOs play a vital role in holding corporations _______ for environmental damage caused by their operations.', options: ['[[accountable|responsables]]', '[[transparent|transparentes]]', '[[liable|responsables legalmente]]'], correctAnswer: 'accountable', acceptableAnswers: ['accountable'], explanation: 'Hold accountable = to require someone to accept responsibility for their actions.' }] },
    topicName: 'Vocabulary',
  },
  {
    id: 'c1-u8-v5', type: 'multiple-choice', level: 'C1', topic: 'global-vocabulary', difficulty: 'hard',
    content: { title: '[[Vocabulary|Vocabulario]]: [[Global Issues|Problemas globales]]', instructions: 'Choose the best word.',
      questions: [{ question: 'The region\'s long history of colonialism has left a lasting legacy of economic _______.', options: ['[[inequality|desigualdad]]', '[[prosperity|prosperidad]]', '[[independence|independencia]]'], correctAnswer: 0, explanation: 'Inequality = the state of not being equal, especially in status, rights or opportunities.' }] },
    topicName: 'Vocabulary',
  },
  {
