...
export const UNIT_10_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    content: { title: '[[Writing|Escritura]]: [[Reflective Essay|Ensayo reflexivo]]', instructions: 'Choose the best sentence to conclude a philosophical essay at C1 level.',
      questions: [{ question: 'Which is the most effective concluding sentence for an essay on the nature of identity?', options: ['[[In conclusion, this essay has argued that identity cannot be reduced to any single determining factor, but is instead the product of an ongoing negotiation between the self and the social, cultural and psychological forces that shape — and are simultaneously shaped by — our developing sense of who we are.|En conclusión, este ensayo ha argumentado que la identidad no puede reducirse a ningún único factor determinante, sino que es el producto de una negociación continua entre el yo y las fuerzas sociales, culturales y psicológicas que moldean nuestro sentido en desarrollo de quiénes somos.]]', '[[What emerges from this analysis is not a definitive answer but something arguably more valuable: a clearer appreciation of why the question itself matters, and why it will continue to do so.|Lo que surge de este análisis no es una respuesta definitiva sino algo posiblemente más valioso: una comprensión más clara de por qué la propia pregunta importa.]]', '[[Ultimately, what this analysis reveals is that the question of identity, far from yielding simple answers, opens onto a broader set of philosophical and ethical concerns that are likely to grow in urgency as globalisation, technology and political upheaval continue to reshape the conditions in which human beings form their sense of self and their relationship to others.|En definitiva, lo que revela este análisis es que la pregunta de la identidad, lejos de ofrecer respuestas simples, se abre a un conjunto más amplio de preocupaciones filosóficas y éticas que es probable que crezcan en urgencia a medida que la globalización, la tecnología y las convulsiones políticas continúen reformando las condiciones en que los seres humanos forman su sentido del yo.]]'], correctAnswer: 1, explanation: '"What emerges from this analysis is..." = cleft; "arguably more valuable" = hedging; "why the question itself matters" = philosophical sophistication.' }] },
    topicName: 'Writing',
  },
  {
