...
import { expandBlockToWordPairMarkup } from '@/lib/bilingual-word-pairs';
...
/** Compatibilidad: mismo comportamiento que expandBlockToWordPairMarkup. */
export const expandC1BlockToWordPairMarkup = expandBlockToWordPairMarkup;
...
export function applyC1QuestionBilingual(exerciseId: string, questionEn: string): string {
  ...
  return expandBlockToWordPairMarkup(questionEn, es);
}
