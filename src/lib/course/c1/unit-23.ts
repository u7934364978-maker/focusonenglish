...
export const UNIT_23_EXERCISES: Exercise[] = [
  ...
  {
    id: 'c1-u23-s1', type: 'multiple-choice', level: 'C1', topic: 'speaking-disasters', difficulty: 'hard',
    content: { title: '[[Speaking|Expresión oral]]: [[Discussing Risk|Hablar sobre el riesgo]]', instructions: 'Choose the most appropriate C1 response.',
      questions: [{ question: 'The interviewer asks: "Should governments prioritise disaster prevention or post-disaster reconstruction?" Choose the best response:', options: [
        '[[Prevention is always better than cure, so governments should always prioritise prevention. It makes no sense to spend money fixing damage when you could stop the damage happening in the first place. All experts agree on this.|La prevención siempre es mejor que la cura, por lo que los gobiernos siempre deberían priorizar la prevención. No tiene sentido gastar dinero arreglando daños cuando podrías evitar que ocurran.]]',
