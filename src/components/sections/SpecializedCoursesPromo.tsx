    ...
    <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="group relative overflow-hidden rounded-2xl border-2 border-slate-200 bg-white hover:border-coral-300 transition-all">
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-coral-100 to-transparent rounded-bl-full"></div>
