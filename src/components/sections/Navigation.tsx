              ...
              {cursosMenuOpen && (
                <div className="absolute top-full left-0 pt-2 w-72 z-[9999]">
                  <div className="bg-white rounded-2xl shadow-coral-lg border-2 border-[#FFE8D9] py-2 animate-slide-down dark:bg-slate-900 dark:border-slate-800">
                    <Link href="/cursos/trabajo" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-[#FFF4ED] hover:to-[#FFE8D9] hover:text-[#FF6B6B] transition-all font-semibold rounded-lg mx-2 whitespace-nowrap dark:text-slate-200 dark:hover:from-slate-800 dark:hover:to-slate-700">
