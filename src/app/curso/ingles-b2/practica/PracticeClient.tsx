...
export default function PracticeClient({ interactions }: Props) {
  ...
  useEffect(() => {
    ...
    const unitData: UnitData = {
      course: {
        ...
        unit_title: 'Práctica Aleatoria B2',
        total_duration_minutes: 30
      },
      learning_outcomes: ['Repaso general de nivel B2'],
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-6 bg-slate-50 p-12 rounded-3xl border border-slate-200 shadow-xl">
          ...
          <p className="text-slate-600 text-lg">
            Has completado todos los ejercicios disponibles para el nivel B2. ¡Increíble trabajo!
          </p>
          <Link 
            href="/curso/ingles-b2"
  ...
  return (
    <PremiumCourseSession 
      ...
      onComplete={() => router.push('/curso/ingles-b2')}
      onExit={() => router.push('/curso/ingles-b2')}
