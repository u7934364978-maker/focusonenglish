        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/curso-ingles-para-trabajo" className="group bg-white p-8 rounded-[2rem] border border-slate-100 hover:border-green-200 hover:shadow-xl hover:shadow-green-50 transition-all">
              ...
              <Link href="/curso-ingles-para-viajar" className="group bg-white p-8 rounded-[2rem] border border-slate-100 hover:border-peach-200 hover:shadow-xl hover:shadow-peach-50 transition-all">
