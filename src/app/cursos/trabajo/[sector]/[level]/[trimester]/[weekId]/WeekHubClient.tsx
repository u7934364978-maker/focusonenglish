...
export default function WeekHubClient({ sector, level, trimester, weekId, weekTitle, lessons }: WeekHubClientProps) {
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
          ...
          <div className="p-8 space-y-4">
            {lessons.map((lesson) => (
              <Link
                key={lesson.id}
                href={`/cursos/trabajo/${sector}/${level}/${trimester}/${weekId}/${lesson.id}`}
