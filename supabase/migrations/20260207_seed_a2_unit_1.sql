...
VALUES (
  ...
  'fill-blank',
  $_$Exercise$_$,
  $_${"questions":[{"sentence":"Hello, my name ___ John.","options":["is","am","are"],"answers":["is"],"explanation":"Usamos 'is' porque estamos hablando de una tercera persona singular, 'my name'.","points":1},{"sentence":"She ___ from Spain.","options":["is","are","am"],"answers":["is"],"explanation":"Se usa 'is' con 'she' (tercera persona singular).","points":1},{"sentence":"I ___ a student.","options":["am","is","are"],"answers":["am"],"explanation":"Usamos 'am' con 'I'.","points":1},{"sentence":"We ___ learning English.","options":["is","are","am"],"answers":["are"],"explanation":"Se usa 'are' con 'we' (primera persona plural).","points":1},{"sentence":"They ___ my friends.","options":["is","are","am"],"answers":["are"],"explanation":"Usamos 'are' porque 'they' es plural.","points":1},{"sentence":"You ___ very kind.","options":["is","are","am"],"answers":["are"],"explanation":"Usamos 'are' con 'you'.","points":1},{"sentence":"He ___ 25 years old.","options":["is","are","am"],"answers":["is"],"explanation":"Se usa 'is' porque 'he' es tercera persona singular.","points":1},{"sentence":"It ___ a sunny day.","options":["is","are","am"],"answers":["is"],"explanation":"Usamos 'is' con 'it' para describir el tiempo.","points":1}]}$_$
) ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;
INSERT INTO public.course_exercises (id, lesson_id, order_index, type, title, content)
VALUES (
  'a2-m1-l1-ex3',
...
VALUES (
  ...
  $_${"title":"Práctica de Pronunciación: Enfoque en el Estrés de la Oración","instructions":"Practica la pronunciación de las siguientes oraciones en inglés, prestando especial atención al estrés de la oración. Usa las transcripciones fonéticas para ayudarte y sigue los consejos de pronunciación.","targetSentences":[{"english":"I am from Spain.","spanish":"Soy de España.","phonetic":"/aɪ æm frɒm speɪn/","audioModelURL":"audio-url-placeholder-1","pronunciationTips":"Enfoca el estrés en 'Spain'. Pronuncia 'am' de forma débil.","focusPoints":"El estrés principal está en 'Spain'.","commonMistakes":"Evita poner el estrés en 'am' o 'from'."},{"english":"He is a student.","spanish":"Él es un estudiante.","phonetic":"/hiː ɪz ə ˈstjuːdənt/","audioModelURL":"audio-url-placeholder-2","pronunciationTips":"Pon el estrés en 'student'. Asegúrate de que la 'u' suene larga.","focusPoints":"El estrés principal está en 'student'.","commonMistakes":"No enfatices 'is' o 'a'."},{"english":"They are my friends.","spanish":"Ellos son mis amigos.","phonetic":"/ðeɪ ɑːr maɪ frendz/","audioModelURL":"audio-url-placeholder-3","pronunciationTips":"Asegúrate de enfatizar 'friends'. La 's' final suena como 'z'.","focusPoints":"El estrés principal está en 'friends'.","commonMistakes":"Evita poner estrés en 'are' o 'my'."},{"english":"Are you from Italy?","spanish":"¿Eres de Italia?","phonetic":"/ɑːr juː frɒm ˈɪtəli/","audioModelURL":"audio-url-placeholder-4","pronunciationTips":"Enfoca el estrés en 'Italy'. La entonación sube al final.","focusPoints":"El estrés principal está en 'Italy'.","commonMistakes":"No enfatices 'Are' o 'from'."},{"english":"We are happy to meet you.","spanish":"Estamos felices de conocerte.","phonetic":"/wiː ɑːr ˈhæpi tu meet juː/","audioModelURL":"audio-url-placeholder-5","pronunciationTips":"Enfatiza 'happy' y 'meet'.","focusPoints":"El estrés principal está en 'happy' y 'meet'.","commonMistakes":"No enfatices 'are' o 'to'."}]}$_$
) ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;
INSERT INTO public.course_exercises (id, lesson_id, order_index, type, title, content)
VALUES (
  'a2-m1-l1-ex9',
...
VALUES (
  ...
  'reading-comprehension',
  $_$Greetings and Introductions$_$,
  $_${"title":"Greetings and Introductions","textPassage":"Hello! My name is Sarah, and I am from Canada. I am a teacher. I have a friend named Alex. He is from Spain, and he is a photographer. We often meet new people at work. When we greet someone, we say 'Hello' or 'Hi'. If we meet someone for the first time, we say 'Nice to meet you'. I work in a school with students from different countries. They are from France, Japan, and Italy. Alex and I have a group of 12 students. The youngest student is 7 years old, and the oldest is 10. We enjoy learning about their cultures and sharing our own. When we say goodbye, we often say 'See you later' or 'Goodbye'.","wordCount":111,"estimatedReadingTime":2,"questions":[{"question":"What is the main idea of the passage?","options":["Sarah and Alex work together.","Sarah and Alex like meeting new people.","Sarah and Alex only teach Canadian students.","Sarah is a student in Canada."],"answer":"Sarah and Alex like meeting new people.","explanation":"El pasaje se centra en cómo Sarah y Alex disfrutan conocer gente nueva a través de su trabajo."},{"question":"Where is Alex from?","options":["Canada","Italy","Spain","France"],"answer":"Spain","explanation":"El texto menciona que Alex es de España."},{"question":"What is Alex's job?","options":["Teacher","Photographer","Student","Doctor"],"answer":"Photographer","explanation":"Alex es fotógrafo según el texto."},{"question":"True or False: Sarah and Alex have students from only one country.","options":["True","False"],"answer":"False","explanation":"Los estudiantes de Sarah y Alex son de diferentes países: Francia, Japón e Italia."},{"question":"How do Sarah and Alex greet someone for the first time?","options":["Hello","Hi","Nice to meet you","Goodbye"],"answer":"Nice to meet you","explanation":"Cuando conocen a alguien por primera vez, dicen 'Nice to meet you'."},{"question":"What is NOT mentioned about the students?","options":["Their nationalities","Their ages","Their hobbies","The number of students"],"answer":"Their hobbies","explanation":"El texto no menciona los pasatiempos de los estudiantes."},{"question":"What is the tone of the passage?","options":["Formal","Friendly","Angry","Sad"],"answer":"Friendly","explanation":"El tono es amigable ya que habla de conocer gente y compartir culturas."}]}$_$
) ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;
INSERT INTO public.course_exercises (id, lesson_id, order_index, type, title, content)
VALUES (
  'a2-m1-l1-ex48',
...
VALUES (
  ...
  'fill-blank',
  $_$Exercise$_$,
  $_${"questions":[{"sentence":"Hello! I ___ Maria. Nice to meet you.","answers":["am"],"explanation":"Usamos 'am' con 'I' para presentarnos. 'I am' significa 'Yo soy'.","points":1},{"sentence":"___ you from Spain?","answers":["Are"],"explanation":"Usamos 'are' con 'you' para preguntar sobre nacionalidad u origen. 'Are you' significa '¿Eres tú?' o '¿Estás tú?'","points":1},{"sentence":"This ___ my friend, John.","answers":["is"],"explanation":"Usamos 'is' con 'this' para presentar a alguien. 'This is' significa 'Este es'.","points":1},{"sentence":"We ___ both 25 years old.","answers":["are"],"explanation":"Usamos 'are' con 'we' para hablar sobre nosotros mismos y otros. 'We are' significa 'Nosotros somos' o 'Nosotros estamos'.","points":1},{"sentence":"They ___ from Italy.","answers":["are"],"explanation":"Usamos 'are' con 'they' para hablar de otras personas. 'They are' significa 'Ellos son' o 'Ellos están'.","points":1},{"sentence":"My brother ___ 30 years old.","answers":["is"],"explanation":"Usamos 'is' con 'he', 'she', o 'it' para describir edades o características. 'He is' significa 'Él es' o 'Él está'.","points":1},{"sentence":"___ she your sister?","answers":["Is"],"explanation":"Usamos 'is' con 'she' para preguntar sobre una persona. 'Is she' significa '¿Es ella?'","points":1},{"sentence":"Good evening! ___ everyone ready?","answers":["Is"],"explanation":"Usamos 'is' con 'everyone' ya que se considera singular. 'Is everyone' significa '¿Está todo el mundo?'","points":1}]}$_$
) ON CONFLICT (id) DO UPDATE SET content = EXCLUDED.content;
