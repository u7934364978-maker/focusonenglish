...
const TRANSLATION_DICT = {
  ...
  'young': 'joven', 'old': 'viejo', 'new': 'nuevo', 'straight': 'recto',
  'curly': 'rizado', 'wavy': 'ondulado', 'good': 'bueno', 'bad': 'malo',
  'beautiful': 'hermoso', 'pretty': 'bonito', 'handsome': 'guapo', 'cute': 'lindo',
  'ugly': 'feo', 'easy': 'fácil', 'difficult': 'difícil', 'hard': 'difícil',
  'soft': 'suave', 'rough': 'áspero', 'warm': 'cálido', 'cold': 'frío',
  'hot': 'caliente', 'dark': 'oscuro', 'bright': 'brillante', 'clean': 'limpio',
  'dirty': 'sucio', 'quiet': 'callado', 'loud': 'ruidoso', 'fast': 'rápido',
  'slow': 'lento', 'strong': 'fuerte', 'weak': 'débil', 'happy': 'feliz',
  'sad': 'triste', 'angry': 'enojado', 'tired': 'cansado', 'friendly': 'amable',
  'kind': 'amable', 'cruel': 'cruel', 'polite': 'educado', 'rude': 'grosero',
  'brave': 'valiente', 'afraid': 'asustado', 'confident': 'confiado', 'shy': 'tímido',
  'proud': 'orgulloso', 'humble': 'humilde', 'youthful': 'juvenil', 'self-conscious': 'cohibido',
  'prominent': 'prominente', 'generous': 'generoso', 'patient': 'paciente',
  'creative': 'creativo', 'energetic': 'energético', 'active': 'activo', 'cheerful': 'alegre',
  'red': 'rojo', 'blue': 'azul', 'green': 'verde', 'yellow': 'amarillo',
  'orange': 'naranja', 'purple': 'morado', 'pink': 'rosa', 'brown': 'marrón',
  'black': 'negro', 'white': 'blanco', 'grey': 'gris', 'blonde': 'rubio/rubia',
...
function translateUnit4() {
  ...
  // ONLY translate these specific fields to avoid nesting issues
  ...
  console.log('✅ Unit 4 translated: questions, explanations, and options');
}
