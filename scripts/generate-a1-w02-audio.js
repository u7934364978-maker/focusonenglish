...
const text = "Your meeting with the manager is on Wednesday at two forty-five PM. Please be on time.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w02-appointment.mp3');

console.log('Generando audio para Semana 2...');
