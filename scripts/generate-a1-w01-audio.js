...
const text = "Hello everyone. My name is Sarah Jenkins. I am your new supervisor. It is nice to meet all of you.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w01-intro.mp3');

console.log('Generando audio para Semana 1...');
