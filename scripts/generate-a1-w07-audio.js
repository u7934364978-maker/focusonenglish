...
const text = "Every morning, I write three reports. Then, I send an email to the IT department because my screen is dark. Finally, I attend a meeting with my team.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w07-tasks.mp3');

console.log('Generando audio para Semana 7...');
