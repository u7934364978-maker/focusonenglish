...
function translateText(text) {
  ...
  // Check if text is already in [[english|spanish]] format
  if (text.includes('[[')) return text;

  let result = text;

  // Create a sorted list of dictionary keys by length (longest first)
...
function processExercises(content) {
  let updated = content;
  ...
  // Find all explanations and translate them
...
async function translateUnit(unitFile) {
  try {
