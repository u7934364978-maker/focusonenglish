...
const text = "Welcome to my office. There is a large desk in the middle. There are two chairs for visitors. There is also a small printer on the shelf.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w05-office-tour.mp3');

console.log('Generando audio para Semana 5...');
