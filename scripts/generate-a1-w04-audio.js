...
const text = "I start my work at eight o'clock. I use my laptop to write emails to my team.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w04-routine.mp3');

console.log('Generando audio para Semana 4...');
