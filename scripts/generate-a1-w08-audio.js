...
const text = "Sarah is my colleague. She works in the Marketing department. She doesn't arrive at 8:00; she arrives at 9:00 AM. She has a very busy day.";
const outputPath = path.join(__dirname, '..', 'public', 'audio', 'w08-sarah-routine.mp3');

console.log('Generando audio para Semana 8...');
