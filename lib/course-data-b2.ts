    ...
    exercises: [
      {
        ...
        explanation: 'El análisis literario y la crítica son habilidades fundamentales para el nivel B2. No se trata solo de decir si algo te gustó o no, sino de examinar cómo funciona una obra narrativa y por qué produce ciertos efectos en el lector.\n\nCuando analizamos una obra literaria, película o serie, debemos considerar varios elementos clave:\n\n**Personajes (Characters)**: El protagonista (protagonist) es el personaje central cuyo viaje o desarrollo seguimos. Los buenos escritores crean personajes matizados (nuanced) - no son simplemente buenos o malos, sino complejos y realistas.\n\n**Temas (Themes)**: Son las ideas universales que explora la obra. Un tema (theme) puede ser el amor, la soledad, la identidad, la justicia, etc. Las obras más convincentes (compelling) suelen explorar varios temas interconectados.\n\n**Lenguaje figurativo**: Los autores usan metáforas (metaphors), símiles y otros recursos literarios para crear significados más profundos. Una metáfora compara dos cosas sin usar "like" o "as" (ejemplo: "Time is money").\n\n**Estilo narrativo**: Cómo se cuenta la historia - el punto de vista, el tono, el ritmo - afecta profundamente nuestra experiencia como lectores.\n\nEste vocabulario te permitirá expresar análisis literarios de forma académica y profesional, una habilidad esencial en contextos educativos y profesionales de habla inglesa.',
        vocabularySet: [
          {
            word: 'protagonist',
